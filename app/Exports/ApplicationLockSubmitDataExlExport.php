...
class ApplicationLockSubmitDataExlExport implements FromCollection,WithHeadings
{
    /**
	...
	*/
    ...
    public function collection(){
		...
		$result = $custom_component_obj->allgetlocksumbittedStudentData($formId, false);
		$i =1 ;
