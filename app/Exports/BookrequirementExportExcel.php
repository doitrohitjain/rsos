...
class BookrequirementExportExcel implements FromCollection,WithHeadings,ShouldAutoSize
{
    /**
	...
	*/
    ...
    public function collection(){
		...
		foreach($result as $data){
            $output[] = array(
				...
				'hindi_auto_student_count'=> @$data['hindi_auto_student_count'],
				'english_auto_student_count'=> @$data['english_auto_student_count'],
				...
				'hindi_required_book_count'=> @$data['hindi_required_book_count'],
				'english_required_book_count'=> @$data['english_required_book_count'],
	...
	public function headings(): array{
        return ["Sr. No.", "Ai Code","Course","Subject","Volume","Hindi Enrollment Student Count","English Enrollment Student Count","Hindi Last Year Book Stock Count","English Last Year Book Stock Count","Hindi Required Book Count","English Required Book Count"];
    } 
