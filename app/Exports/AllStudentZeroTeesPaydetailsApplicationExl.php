...
class AllStudentZeroTeesPaydetailsApplicationExl implements FromCollection,WithHeadings
{
    /**
	...
	*/
    ...
    public function collection(){
		...
		$result = $custom_component_obj->allgetStudentzerofeesPaymentData($formId, false);
		$i =1 ;
