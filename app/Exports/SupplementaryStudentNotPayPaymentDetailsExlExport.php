...
class SupplementaryStudentNotPayPaymentDetailsExlExport implements FromCollection,WithHeadings
{
    /**
	...
	*/
    ...
    public function collection(){
		...
		$result = $custom_component_obj->allgetSupplementaryStudentNotPayPaymentData($formId, false);
		$i =1 ;
