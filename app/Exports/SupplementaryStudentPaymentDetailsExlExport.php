...
class SupplementaryStudentPaymentDetailsExlExport implements FromCollection,WithHeadings
{
    /**
	...
	*/
    ...
    public function collection(){
		...
		$result = $custom_component_obj->getSupplementaryallStudentPaymentData($formId, false);
		$i =1 ;
	...
	public function headings(): array{
        return ["Sr. No.", "Enrollment","Name","Gender","Course","Stream","Admission","challanNumber","feepaidamount","submitted","Ai Center"];
    }	 
