...
class SupplementaryStudentLockSumbitedApplicationsExlExport implements FromCollection,WithHeadings
{
    /**
	...
	*/
    ...
    public function collection(){
		...
		$result = $custom_component_obj->getSupplementarylocksumbittedStudentData($formId, false);
		$i =1 ;
	...
	public function headings(): array{
        return ["Sr. No.", "Enrollment","Name","Gender","Course","Stream","Admission","Ai Center",];
    }	 
