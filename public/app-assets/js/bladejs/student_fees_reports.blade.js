$(function () { 
    ...
    var tableId = "#AiCenters_Wise_Admission_Report";
    ...
    var table = $(tableId).DataTable({
       ...
       "bFilter": false,
		...
		ajax: {
			url: config.routes.application_ai_center_wise_count,
			type: 'GET',
            data: function (d) {
        ...
        columns: [
			...
			{data: 'student_lock_submit_by_aicode', name: 'student_lock_submit_by_aicode','defaultContent':''},	
...
$(submitFilterBtn).click(function(){  
    var table =  $("#AiCenters_Wise_Admission_Report").DataTable().draw(true); 
});