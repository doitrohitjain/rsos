...
<!-- BEGIN: Page Main-->
    ...
    <div class="card-content">
      <p class="caption mb-0"><h6>Add Required Document <span style="margin-left: 85%;"><a href="{{ route('getpublishaicentermaterial') }}" class="btn btn-xs btn-info pull-right">Back</a></span>
<h6></p>
    </div>
	</div>
  <div class="row">
      ...
      <div id="html-validations" class="card card-tabs">
        <div class="card-content">
          <div id="html-view-validations">
           {!! Form::model( ['method' => 'post','url'=>url()->current()]) !!}
				<div class="row">
	                <div class="col m4 s12">
						...
						<div class="input-field">{!!Form::select($fld,$adm_type,null,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'required'=>'true']); !!}
		        	...
		        	<div class="col m4 s12">
						...
						<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
						<div class="input-field">{!!Form::select($fld,$course,null,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'required'=>'true']); !!}
							@include('elements.field_error')	
						</div>
					</div> 
					<div class="col m4 s12">
						...
						<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
						<div class="input-field">{!!Form::select($fld,$verfication_label,null,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'required'=>'true']); !!}
							@include('elements.field_error')
					...
					<div class="col m4 s12">
						...
						<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
						<div class="input-field">{!!Form::text($fld,null,['type'=>'text','class'=>'form-control','autocomplete'=>'off','placeholder' => $lbl,'required'=>'true']); !!}
							@include('elements.field_error')
						</div>
					</div>
					<div class="col m4 s12">
					...
					<div class="row">
						<div id="toolbar"></div>
							...
							<textarea class="form-control ckeditor" id="ckeditorId" name="field_name"></textarea>
							</div> 
						</div>
					<div class="col m4 s12">
		                ...
		                {!!Form::select($fld,$status,@$user->$fld,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'required'=>'true']); !!}
							@include('elements.field_error')	
						</div>
					</div>  
		        </div> 
