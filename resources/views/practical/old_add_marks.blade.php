												...
												@foreach(@$master as $k=>$data)
													<tr>
														...
														<td>
															...
															?>
															<input type='checkbox' id="practicalAbsent<?php echo $i; ?>" name='data[{{ $k }}][practical_absent]' value="{{@$data->id}}" class="practical_absent practical_absent_<?php echo $i; ?>  check_absent_marks" <?php echo $is_check_class; ?> /><span></span>
...
@section('customjs')
	...
	<script src="{!! asset('public/app-assets/js/bladejs/practical/old_add_marks.js') !!}"></script> 
@endsection 