...
<html>
	...
	<body style="margin-top:-5%,margin-bottom:0%">
		...
		<table class="table table-responsive" style="border:0.2px solid rgba(2, 2, 2, 0.377);border-bottom:3px solid black" width="100%">
			<tbody>
				<tr>
					<th style="width:10%;">
						<h2>
							<img src="{{asset('public/app-assets/images/favicon/administrator.png')}}" style="width: 60px; height: 60px; border-radius: 10px" alt="image upload button"/>
						</h2>
					</th>
					<th style="width:90%">
		...
		<br>
		<table class="table table-responsive"   style="border:0.2px solid rgba(2, 2, 2, 0.377);" width="100%">
				<tr>
					<td style="width:14%;padding:10px;"><span><b>Examination Center fixcode</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$examiner_list[$examcenter_detail_id]}}</span></td>
					<td style="width:14%;padding:10px;"><span><b>Course</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$course[$course_id]}}</span></td>
					<td style="width:14%;padding:10px;"><span><b>Subject</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$subjects[$subject_id]}}</b></span></td>
				</tr>	
				<tr>
					...
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$sso_id}}</span></td>
					<td style="width:14%;padding:10px;"><span><b>Examiner Name</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$usersname->displayName}}</span></td>
				</tr>
				<tr>
					<td style="width:14%;padding:10px;"><span><b>Total Students Appearing</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$markingAbsentData->total_students_appearing}}</span></td>
					<td style="width:14%;padding:10px;"><span><b>Total Copies of the subject</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$markingAbsentData->total_copies_of_subject}}</span></td>
					<td style="width:14%;padding:10px;"><span><b>Total Absent</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$markingAbsentData->total_absent}}</span></td>
				</tr>		
				<tr>
					<td style="width:14%;padding:10px;"><span><b>Total</br> NR</b></span></td>
					<td style="width:1%;padding:10px;"><span><b></b></span></td>
					<td style="width:15%;padding:10px;"><span>{{@$markingAbsentData->total_nr}}</span></td>	
		...
		<table class="table table-responsive"  width="100%">
			...
			<tr><td style='padding:1%'><table class='table table-responsive' width="100%">
				...
				<?php  
				/*<tr><td style='width:37%; vertical-align:top;'><table style='width:100%;vertical-align:top;'>*/
				...
				<tr>
					...
					<!--<th class="bothBorder" style="width:30%">Subject Maximum Marks</th>-->
				...
				<tr>	
					...
					<!--<td><?php //echo (isset($subject_maximum_marks) && !empty($subject_maximum_marks))? $subject_maximum_marks:'-'; ?></td>-->
					
					
					<?php 
						$data=ThoeryCustomComponent::getTheoryAbsentStudent($course_id,$subject_id,$examcenter_detail_id,$records->fixcode);
						
						if(isset($data->theory_absent) && $data->theory_absent==1){
							echo "<td style='text-align:center;font-weight:bold;width:100px;height:40px;'>".strtoupper('Absent')."</td>";
						}elseif(isset($data->theory_absent) && $data->theory_absent==2) { 
							echo "<td style='text-align:center;font-weight:bold;width:100px;height:40px;'>".strtoupper('NR')."</td>";
							
						} else{
							echo "<td style='height:40px;text-align:center;padding:0.8%'><input type='text' style='border:1px solid #000000;width:90px;height:35px' /></td>";	
						}
					?>
		...
		<table style="clear:both;width:100%;margin-top:150px;">
			<tbody>
				<tr style='border:0.5px solid white '>
					...
					<td align="right" style="width:33%;"><div><b>Total :</b>&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' style='border:1px solid #000000;width:90px;height:30px' /></div> <div style='width:50px;'></div></td>
