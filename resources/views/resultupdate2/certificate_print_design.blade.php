...
if($passfail == 'XXXX' || $passfail == 'XXXX' || $passfail == "xxxx"){ ?> 
...
<table width="100%">
	...
	<td style="padding-top:0px;">
		<table width="100%" style="margin-left:5%;">
			...
			<tr>
				...
				<td><span class="bigfontset"><br><!-- Revised -->{{@$marksheet_type}} <br> Issued On <?php echo date('d-m-Y');?></span></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		<td><table width="100%" style="margin-top:3%;">
			<tr>
				<td width="90%">
					<table width="100%">
						<tr>
	...
	<tr>
		<td style="padding-top:50px;"><table width="100%" style="text-align:center;">
			<tfoot>
				<tr>
					<td width="40%"><!-- JAIPUR --></td>
					<td width="60%"><img src="{{asset('public/app-assets/images/favicon/signatureinpdf1.png')}}" style="width: 70px;" align="center"/><br></td>
				</tr>
			</tfoot>
		  </table> 
		  </td>
		...
		<td><table width="100%" style="text-align:center;">
			<tfoot>
				<tr>
					...
					<td width="55%"  ><b>RAJENDRA KUMAR SHARMA</b><!-- Secretary RSOS --><br><br></td> 
				</tr>
			</tfoot>
		  </table> 
		  </td>
