						...
						<div class="card-content">						
							...
							{!! method_field('PUT') !!}
								...
								<div class="col m12 s11">
										@php 
										    $lbl="टिप्पणी(Remarks)"; $fld='remarks'; 
										@endphp 
										<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
										<div class="input-field">
										{!! Form::textarea($fld,$rejectvalue,['class'=>'form-control', 'rows'=> 30, 'cols'=> 100]) !!}
											@include('elements.field_error')	
										</div>
									</div>
									</div>
								<div class="row">
									<div class="col m10 s12 mb-3">
										<button class="btn cyan waves-effect waves-light right " style="background: linear-gradient(45deg,#303f9f,#7b1fa2); type="submit" name="action">Mark Reject
										</button>
									</div>
