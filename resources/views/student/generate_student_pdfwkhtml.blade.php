...
<body style="margin-top:-6%,margin-bottom:0%"><br>
<div class="cc51"> 
...
RSOS Form - Academic session {{ now()->year }}-{{ now()->year-2000+1 }}
</div>&nbsp;
@if($master->application->category_a !=7)
<span style="color: red; font-size:20px;">Notes:- Forwarding Fees of Rs. 50/- and Online Service Fees of Rs. 30/- to be paid offline to the AI center</span></br></br>
@endif
<table border="1 grey" style="width:100%;">
	<tbody>
		<tr>
			<td colspan="3"><span style="font-size:13px;"><span class='customStrong'>&nbsp;Enrollment Number:</span> <b>{{@$master->enrollment}} </b></span></td>
		</tr>
		<tr>
			<td colspan="3"><span class="font"><span class='customStrong'>&nbsp;AI Center Name:</span> {{@$aiCenters[@$master->ai_code]}}</span></td>
		</tr>
		<tr>
			<td style="width: 50%;"><span class='customStrong'>&nbsp;प्रवेश आवेदन का प्रकार</span><span>(Admission of Type)</span></td>
			<td colspan="2" rowspan="1"><span style="font-size:12px;">&nbsp;{{@$adm_types[@$master->adm_type]}}</span></td>
		</tr>
		<tr>
			<td style="width: 50%;"><span class="font"><span class='customStrong'>&nbsp;परीक्षा&nbsp;(Exam)</span></span></td>
			<td colspan="2"><span class="font">&nbsp;{{@$exam_session[@$master->exam_month]}}</span></td>
		</tr>
	</tbody>
</table>

<div><span class="font"><span class='customStrong'>&nbsp;व्यक्तिगत विवरण(Personal Details)</span></span></div>
...
<div><span class="font"><span class='customStrong'>&nbsp;बैंक विवरण( BANK Details)</span></span></div>
<table border="1 grey" style="width:100%;">
	<tbody>
		<tr>
...
<div><span class="font"><span class='customStrong'>&nbsp;विषय विवरण(Subject Details)</span></span></div>
<div><span class="font"><span class='customStrong'>&nbsp;अनिवार्य विषय(Compulsory Subject)</span></span></div>
<table border="1 grey" style="width:100%;">
	<tbody>
		<!--<tr>
...
<div><span class="font"><span class='customStrong'>&nbsp;अतिरिक्त विषय(Additional Subject)</span></span></div>
<table border="1 grey" style="width:100%;">
	<tbody>
		<!--<tr>
...
<div><span class="font"><span class='customStrong'>&nbsp;क्रेडिट&nbsp;स्थानांतरण(Transfer of Credit) :</span></span></div>
...
<div><span class="font"><span class='customStrong'>&nbsp;टीओसी&nbsp;विषय(Toc subjects) :</span></span></div>
<table border="1 grey" style="width:100%;">
	<tbody>
		<!--<tr>
...
<div><span class="font"><span class='customStrong'>&nbsp;Examination Subject in which the candidate wants to appear : </span></span></div>
<table border="1 grey" style="width:100%;">
	<tbody>
		<!--<tr>
...
@endif
<div><span class="font"><span class='customStrong'>&nbsp;परीक्षा शुल्क विवरण(Exam Fees Details)</span></span></div>
...
<div><span style="font-size:12px;"><span class='customStrong'>&nbsp;पते का विवरण(Address Details)</span></span></div>
...
@endif  						
					...
					<input type="checkbox" name="" value="" checked disabled class=>
					<span style="font-size:16px;">
