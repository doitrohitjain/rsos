								...
								<div class="card-content">
									...
									<div class="row">
										...
										<div class="input-field col s4 pass-year-section" <?php if(empty($master->year_pass)) { echo 'style="display:none;"'; } ?> >
											...
											@endphp
											<h6>@php 
											echo $lbl.Config::get('global.starMark'); @endphp </h6>
											{!! Form::select($fld,$rsos_years_dropdown, @$master->$fld, ['class' => 'form-control year_pass_field select2 select2a browser-default center-align toc-section-field','required'=>'required','placeholder' =>$placeholder]) !!}
											@include('elements.field_error')
										</div>
					...
					<div class="seaction">
						...
						<div class="col s12 m12 l12">
							<div id="Form-advance" class="card card card-default scrollspy">
								...
								@php echo Config::get('global.toc_page_note');@endphp								
								</span>
								</div>	
								<div class="card-content">								
									<span class="invalid-feedback" role="alert" style="color:red;font-size:18px;">
									...
									<div class="row">
										...
										<div class="input-field col s4 pass-year-section" >
											...
											@php
											$improvement_years_dropdown = array('124' => '2022-23');
											$lbl='सफल होने के वर्ष (Years of Passing) :'; $placeholder = "Select Year"; $fld='year_pass';
											@endphp
											<h6>@php echo $lbl.Config::get('global.starMark'); @endphp </h6>
											{!! Form::select($fld,$admission_sessions, Null, ['class' => 'year_pass_field form-control select2 select2a browser-default center-align toc-section-field','placeholder' =>$placeholder]) !!}
											@include('elements.field_error')
										</div>
								...
								<div class="card-content">
									...
									<div class="row">
										...
										<div class="input-field col s4 pass-year-section" <?php if(empty($master->year_pass)) { echo 'style="display:none;"'; } ?> >
											...
											@endphp
											<h6>@php echo $lbl.Config::get('global.starMark'); @endphp </h6>
											{!! Form::select($fld,$rsos_years_dropdown, @$master->$fld, ['class' => 'form-control year_pass_field select2 select2a browser-default center-align toc-section-field','placeholder' =>$placeholder]) !!}
											@include('elements.field_error')
										</div>
									...
									<div class="row">
										<div class="col m10 s12 mb-3">
											<button class="btn cyan btn_disabled waves-effect waves-light right " type="submit" name="action"> Save & Continue
											</button>
										</div>
										<div class="col m2 s10 mb-3">
											<button class="btn cyan waves-effect waves-light right" type="reset">Reset
