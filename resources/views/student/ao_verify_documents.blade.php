						...
						<div class="col s12">
							<div class="card">
								<div class="card-content">
									...
									<a href="{{ route('dev_toc_subject_details',encrypt($student_id)) }}" class="waves-effect waves-teal btn gradient-45deg-deep-orange-orange white-text secondary-content" title="Click here to Update TOC." >
										TOC
									</a>
								</div>
							</div>
