...
<!-- BEGIN: Page Main-->
    ...
    <div class="card-content">
      <p class="caption mb-0"><h6>Student From <span style="margin-left: 85%;"><a href="{{ route('students.index') }}" class="btn btn-xs btn-info pull-right">Back</a></span>
<h6></p>
    </div>
	</div>
  <div class="row">
           ...
           {!! Form::open(array('route' => 'students.store','method'=>'POST')) !!}
              <div class="row">
                <div class="input-field col s12">
                  ...
                  {!! Form::text('ssoid', null, array('class' => 'form-control','autocomplete'=>'off')) !!}
				   @error('ssoid')
