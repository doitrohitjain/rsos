...
<!-- BEGIN: Page Main-->
    ...
    <div class="card-content">
      <p class="caption mb-0"><h6>User From <span style="margin-left: 85%;"><a href="{{ route('users.index') }}" class="btn btn-xs btn-info pull-right">Back</a></span>
<h6></p>
    </div>
	</div>
  <div class="row">
             ...
             @php $lbl='चयन  ब्लॉक (block):'; $placeholder = "Select ". $lbl; $fld='block_id'; @endphp
              <span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
			   ...
			   <div class="input-field col s12">
                    @php $lbl="भूमिकाओं(Roles)"; $fld='username'; @endphp 
                   {!! Form::select('roles[]', $roles,[], array('class' => 'form-control','multiple')) !!}
				    <label for="uname0">@php echo $lbl .Config::get('global.starMark'); @endphp</label>
				   @error('roles')
