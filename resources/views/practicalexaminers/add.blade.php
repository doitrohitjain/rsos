                        ...
                        <div id="html-validations" class="card card-tabs">
                            <div class="card-content">
                                <div id="html-view-validations">
                                    {!! Form::open(array('route' => 'practicalexamineradd','method'=>'POST','id'=>'practicalexamineradd')) !!}
									{!! Form::token() !!}
									{!! method_field('PUT') !!}
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            ...
                                            {!!Form::text($fld,@$master->$fld,['type'=>'text','class'=> $fld . ' form-control','autocomplete'=>'off','required'=>'required']); !!}
                                            @include('elements.field_error')
                                        </div>
                                        <div class="input-field col s6">
                                            @php $lbl='पूरा नाम (Full Name)'; $fld='name'; @endphp
                                            <h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
                                            {!!Form::text($fld,@$master->$fld,['type'=>'text','class'=> $fld . ' form-control  txtOnly','autocomplete'=>'off','required'=>'required']); !!}
                                            @include('elements.field_error')
                                        </div>
                                        <div class="input-field col s6">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
                                            {!!Form::text($fld,@$master->$fld,['type'=>'text','minlength'=>'10','maxlength'=>'10','class'=> $fld . ' num form-control','autocomplete'=>'off','required'=>'required']); !!}
                                            @include('elements.field_error')
                                        </div>
                                        <div class="input-field col s6">
										...
										@php if($isAdminStatus==true){ @endphp
										 <div class="input-field col s6">
											...
											{!! Form::select($fld,@$district_list,null,['class' => 'select2 browser-default form-control center-align district_id','placeholder' => $placeholder,'id'=>'district_id','style' => 'text-align: left','required'=>'required']) !!}
											@include('elements.field_error')
											</div>
										</div>
										 ...
										 <div class="input-field col s6">
                                            ...
                                            {!! Form::select($fld,array(),null,['class' => 'select2 browser-default form-control center-align deo_id','placeholder' => $placeholder,'id'=>'deo_id','required'=>'required']) !!}
											@include('elements.field_error')
                                        </div>
										@php } else { @endphp
                                        ...
                                        <div class="row">
                                            <div class="col m10 s12 mb-3">
												...
												<a href="{{ route('practicalexamineradd') }}" class="btn cyan waves-effect waves-light right">Reset</a>
                                            </div>
...
@endsection
@section('customjs')
	<script src="{!! asset('public/app-assets/js/bladejs/practical/practicalexamineradd.js') !!}"></script> 
@endsection 
