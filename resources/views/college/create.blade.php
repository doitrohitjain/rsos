...
<!-- BEGIN: Page Main-->
    ...
    <div class="card-content">
      <p class="caption mb-0"><h6>Colleges From <span style="margin-left: 85%;"><a href="{{ route('colleges.index') }}" class="btn btn-xs btn-info pull-right">Back</a></span>
<h6></p>
    </div>
	</div>
  <div class="row">
      ...
      <div id="html-validations" class="card card-tabs">
        <div class="card-content">
          <div id="html-view-validations">
           {!! Form::open(array('route' => 'colleges.store','method'=>'POST')) !!}
              <div class="row">
                <div class="input-field col s12">
                  <label for="uname0">ssoid*</label>
                  {!! Form::text('ssoid', null, array('class' => 'form-control')) !!}
				   @error('ssoid')
               ...
               @enderror
				...
				<div class="input-field col s12">
                  <label for="uname0">Fullname*</label>
