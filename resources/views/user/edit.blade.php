          ...
          <div id="html-view-validations">
           {!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user->id],'id' => $model]) !!}
			  ...
			  <div class="col m4 s12">
                ...
                {!!Form::text($fld,$user->$fld,['type'=>'text','class'=>'form-control sso_id','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>100,'minLength'=>2]); !!}
              ...
              <div class="col m4 s12">
				...
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
				<div class="input-field">
                {!!Form::text($fld,$user->$fld,['type'=>'text','class'=>'form-control name','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>100,'minLength'=>2]); !!}
					@include('elements.field_error')	
				</div>
			</div>
             <div class="col m4 s12">
			...
			<div class="input-field"> 
              ...
              <div class="col m4 s12">
				...
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
				<div class="input-field">
                {!!Form::text($fld,$user->$fld,['type'=>'text','class'=>'form-control mailPersonal','autocomplete'=>'off','placeholder' => $lbl]); !!}
					@include('elements.field_error')	
				</div>
			</div>
			</div>
			...
			<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
			<div class="input-field">
			{!! Form::select($fld,@$gender_id,$user->$fld, ['class' => 'select2 browser-default form-control center-align gender','placeholder' => $placeholder]) !!}
			...
			<span class="small_lable">@php echo $lbl; @endphp </span>
			<div class="input-field">
			{!! Form::select($fld,@$stream_id,$user->$fld, ['class' => 'select2 browser-default form-control center-align allstreamcourseadmtype stream streams','placeholder' => $placeholder,'id'=>'stream']) !!}
			@include('elements.field_error')
			</div>
		   </div>
		    <div class="col m3 s12">
						...
						<span class="small_lable">@php echo $lbl; @endphp </span>
                        <div class="input-field">
                  {!!Form::text($fld,$user->$fld,['type'=>'text','class'=>'form-control num mobile','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>10,'minLength'=>10]); !!}
                          @include('elements.field_error')	
                        </div>
                      </div>
					  <div class="col m3 s12">
			...
			<div class="col m3 s12">
             ...
             <div class="col m3 s12">
				...
				<span class="small_lable">@php echo $lbl; @endphp </span>
				<div class="input-field">
               {!!Form::text($fld,$user->$fld,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>15,'minLength'=>12]); !!}
					@include('elements.field_error')	
				</div>
			</div>
			    <div class="col m3 s12">
