...
<html>
	...
	<body style="margin-top:-5%,margin-bottom:0%">
		<div class="cc51"> 
			...
			<span style=" font-size:28px" class="font">Mapping Examiner List</span>
		</div>
		...
		<table border="1" style="width:100%;">
			<thead>
				<tr>
					...
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;Name of the Examiner</th>
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;SSO ID</th>
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;Moblie</th>
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;Designation</th>
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;Addtional Mobile</th>
				</tr>
			<thead>	
			<tbody>
				<?php 
				...
				<tr>
					...
					<td style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;{{ $data->additional_mobile }}</td>
				</tr>
				<?php $i++; } } ?>
			<tbody>	
		</table>
