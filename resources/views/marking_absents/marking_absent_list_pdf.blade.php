...
<html>
	...
	<body style="margin-top:-5%,margin-bottom:0%">
		<div class="cc51"> 
			...
			<span style=" font-size:28px" class="font">{{$title}}  {{$examSession[$current_exam_month]}}</span>
		</div>
		...
		<table border="1" style="width:100%;">
			<thead>
				<tr>
					...
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;Exam Center</th>
					...
					<!-- <th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> Exam Year</th>
					<th style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> Exam Session</th> -->
			...
			<tbody>
				...
				<tr>
					...
					<!-- <td style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;{{ $examYear[$data->exam_year] }}</td>
					<td style="font-size:16px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;{{ $examSession[$data->exam_session] }}</td> -->
				</tr>
				<?php $i++; } } ?>
			<tbody>	
		</table>
