...
<head>
    ...
    <title>Your request couldn't initiated. Please try again.</title>
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      ...
      <div class="error-code m-0">Your request couldn't initiated. Please try again.</div>
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="{{ url()->previous() }}">
        Go Back
      </a>
    </div>
  </div>
