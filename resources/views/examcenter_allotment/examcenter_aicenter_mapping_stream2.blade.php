							...
							<div id="Form-advance" class="card card card-default scrollspy">
								<div class="card-content">
									...
									<div class="row form-center">
										...
										<input type="hidden" name='stream' value='2' id='stream'>
										...
										<div class="row">
											...
											<div class="input-field col s12">
												...
												{!!Form::text($fld,@$master->$fld,['type'=>'text','required' => 'required','class'=>'supp-student-10-input form-control num','maxlength'=>6,'minLength'=>1,'autocomplete'=>'off','readonly'=>'readonly']); !!}
												@include('elements.field_error')
											</div>
										</div>
										...
										<div class="row">
											<div class="input-field col s12">
												...
												<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
												{!!Form::text($fld,@$master->$fld,['type'=>'text','required' => 'required','class'=>'supp-student-12-input form-control num','maxlength'=>6,'minLength'=>1,'autocomplete'=>'off','readonly'=>'readonly']); !!}
												@include('elements.field_error')
											</div>
										</div>
										...
										<div class="row">
											<div class="input-field col s12">
												...
												<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
												{!!Form::text($fld,@$master->$fld,['type'=>'text','required' => 'required','class'=>'student-10-input form-control num','maxlength'=>6,'minLength'=>1,'autocomplete'=>'off']); !!}
												@include('elements.field_error')
											</div>
										</div>
										...
										<div class="row">
											<div class="input-field col s12">
												...
												<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
												{!!Form::text($fld,@$master->$fld,['type'=>'text','required' => 'required','class'=>'student-12-input form-control num','maxlength'=>6,'minLength'=>1,'autocomplete'=>'off']); !!}
												@include('elements.field_error')
											</div>
										</div>
...
@endsection 
@section('customjs')
	<script src="{!! asset('public/app-assets/js/bladejs/examcenter_aicenter_mapping_stream2.js') !!}"></script> 
@endsection 
