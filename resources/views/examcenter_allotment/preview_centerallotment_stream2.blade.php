...
<div id="main">
	<div class="row"> 
        <div id="breadcrumbs-wrapper" data-image="../../public/app-assets/images/gallery/breadcrumb-bg.jpg">
			...
			<a href="{{route('listing')}}" class="btn btn-xs btn-info right" style="margin-top:1%;margin-right:1%;">Exam Center Listing</a>
		</div>
					...
					<div class="row">
						<div class="col s12">
							<div class="card">
								<div class="card-content">
									<div class="row right">	
										{{-- here we may put button --}}
									</div> 
									<div class="row"> 
										@include('elements.examcenter_allomtnet_listing_stream2')
									</div>
								</div>
							</div>
						</div>
