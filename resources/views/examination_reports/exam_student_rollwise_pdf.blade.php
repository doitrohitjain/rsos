...
<div style="page-break-inside: avoid">
		...
		<tbody>
			<tr>
				...
				<td style="text-align:center;vertical-align:middle;">
					...
					<h4 style="margin-top:-10px;">SUBJECT WISE ROLL(Examination,<?php 
		...
		<table style="width:100%;" class="font">
			<tbody>
				<tr>
					...
					<td width="33%" style="text-align:center;font-size:16px;">Subject : {{ $subjectList[$data['subject_id']]}} [Theory]
					</td>
	...
	<div class="col-md-12" style="margin-top:25px;">
		...
		<table style="width:100%">
				<tr>
					<td colspan='10' width="100%" style="text-align:right"><b>Total Students : {{ $enrollment_count }}</b>
					</td>
				</tr>
		</table>
			...
			<tbody>
				...
				<tr>
								...
								if(isset($data['suppStudentData']) && !empty($data['suppStudentData'])){ 
									...
									?>				
					<td style="font-size:16px; padding:5px 5px 5px 5px">{{ @$SuppEnrollement->enrollment }}</td>
		...
		<table style="width:100%">
			<tbody>
				<tr>
					<td colspan='10' width="100%" style="text-align:right"><b>Toal Students : {{ $supp_enrollment_count }}</b>
					</td>
				</tr>
			</tbody>
		</table>
