           ...
           @endforeach
				...
				foreach($master as $key => $aicodeStudent){ ?>
					...
					<!-- <div class="col-sm-12 well well-sm" style="margin-top:20px; width:100%; border:2px; float:left;"> */
						...
						<div style="width:49%;float:left;margin-left: 5px;border-bottom:2px solid;height:290px;">
							...
							<table style="margin-top:1px;">
								...
								<?php if(isset($aicodeStudent['examsubject']) && !empty($aicodeStudent['examsubject'])){ ?>
										...
										<td >
											<table style="width:100%;" id="signaturetbl3">
												...
												<tr>
													...
													<td style="margin-bottom:10px;">
														@if(!empty($aicodeStudent['signature']))  
														<img alt="materialize logo" height="60px" src="{{asset('public/documents/'.$aicodeStudent['student_id'].'/'.$aicodeStudent['signature'])}}" width="60px" height="30px" /> 
														@else 
									...
									<span style="margin-left:360px; padding-top:270px;position: fixed;"><?php echo $i;?></span>
								<?php } ?>
							</table>
