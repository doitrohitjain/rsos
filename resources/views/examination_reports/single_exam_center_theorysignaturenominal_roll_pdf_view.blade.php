	...
	<div class="row">
      ...
      <div id="tap-target" class="card card-tabs">
        <div class="card-content">
             {!! Form::open(array('route' => 'single_exam_center_theorysignaturenominal_roll_pdf_request','method'=>'POST')) !!}
            <div class="row">
        ...
        <div class="row">
          ...
          <div class="col m2 s12 mb-2">
            <a href="{{route('single_exam_center_theorysignaturenominal_roll_pdf_view')}}" class="btn cyan waves-effect waves-light right">Reset </a>
          </div>
        </div> 
   {{ Form::close() }}
      </div>
           ...
           <div class="card-content">
            ...
            <div class="row">
              <div class="col s12 center">
			    <a href="{{ route('exam_subjectthory_student_rollwise_pdf',[10,1,0]) }}" class="btn mt-2"> exam center Thory signature Nominal roll  10 stream-1 Generate</a>
                &nbsp;
                <a href="{{ route('exam_subjectthory_student_rollwise_pdf',[12,1,0]) }}" class="btn mt-2">exam center Thory signature Nominal  roll 12 stream-1 Generate</a>
				</div>
				 <div class="col s12 center">
			    <a href="{{ route('exam_subjectthory_student_rollwise_pdf',[10,2,0]) }}" class="btn mt-2"> exam center Thory  signature Nominal  roll  10 stream-2 Generate</a>
                &nbsp;
                <a href="{{ route('exam_subjectthory_student_rollwise_pdf',[12,2,0]) }}" class="btn mt-2"> exam center Thory signature Nominal  roll  12 stream-2 Generate</a>
				</div>
              </div>
            </div>
        </div>
