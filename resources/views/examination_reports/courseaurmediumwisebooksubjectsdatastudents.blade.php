	...
	<div class="row">
      ...
      <div id="tap-target" class="card card-tabs">
        <div class="card-content">
             {!! Form::open(array('route' => 'courseaurmediumwisebooksubjectsdatastudents','method'=>'POST')) !!}
            <div class="row">
			...
			{{--<div class="col m3 s12">
					@php $lbl='Is Eligible'; $placeholder = "Select ". $lbl; $fld='is_eligible'; @endphp
					<span class="small_lable">@php echo $lbl ; @endphp </span>
					<div class="input-field">
					{!! Form::select($fld,@$yes_no,null,['class' => 'select2 browser-default form-control center-align allstreamcourseadmtype admtype admtypes','placeholder' => $placeholder,'id'=>'stream21']) !!}
					@include('elements.field_error')
					</div>
				</div>--}}
        <div class="row">
          ...
          <div class="col m2 s12 mb-2">
            <a href="{{route('courseaurmediumwisebooksubjectsdatastudents')}}" class="btn cyan waves-effect waves-light right">Reset </a>
          </div>
        </div> 
   {{ Form::close() }}
      </div>
