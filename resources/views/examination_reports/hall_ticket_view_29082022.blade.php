...
@php 
	...
	if(isset($students) && !empty($students)){
		...
		@endphp
				<div class='admitCard'>
					<div class="row" style="border-style: groove;margin-top:20px;margin-left:5px;margin-right:5px;">
					
						<table  cellspacing="0" style="width:100%;">
		<tr>
			<td style="width:10%">
			<p><img src="{{asset('public/app-assets/images/favicon/administrator.png')}}" style="width: 50px; height: 50px; border-radius: 10px ;padding:15px;" alt="image upload button"/></p>
			</td>
			<td style="text-align:center; vertical-align:middle">
			<span style="font-size:18px;"><b>RAJASTHAN STATE OPEN SCHOOL,JAIPUR <br><?php echo @$examDates[1];
...
{ ?>
											Senior Secondary
										<?php
} ?>Examination, (Hall Ticket)</b></span>
									...
									<table id="example2" class="table2" role="grid" aria-describedby="example2_info" style="width:100%;padding-right:15px;">
										<tbody>
											<tr>
												...
												<td style="margin-right:25px;"><table>
												<tr>
												<th style="font-size:12px;"><b>Roll No.: {{$student['enrollment']}}</b>
												</th>
												</tr>
												<tr>	
...
if ((@$student['exam_subjects']['P'])){
    ...
    echo "</table>";
											...
											<tbody>
												...
												<tr>
													<td colspan=4>
														...
														<img alt="materialize logo" height="120px" src="{{asset('public/app-assets/images/niyam.png')}}" width="600px" />							
													</td>  
												</tr>
				...
				<table>
                                             <tr>
                                              <th style="padding-left:130px;"><img src="{{asset('public/app-assets/images/favicon/signatureinpdf2.jpg')}}" alt="Logo" style="width: 50px; height: 40px; "></th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <th style="padding-left:180px;"><img src="{{asset('public/app-assets/images/favicon/signatureinpdf1.png')}}" alt="Logo" style="width: 75px; height: 25px;"></th>
                                               
                                                </tr>
                                                <tr>
                                                <td style="padding-left:130px;">Asstt.Director Exam.</td>
                                                <td style="padding-left:180px;">Secretary</td>
                                            </tr>
                                                </table>
