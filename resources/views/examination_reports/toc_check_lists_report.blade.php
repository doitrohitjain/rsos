...
<div id="main">
    ...
    <div class="col s12 m12">
      <div id="Form-advance" class="card card card-default">
		<h4 class="header">&nbsp;<span style="color:green;">Download TOC Checklist AI Code Wise</span></h4>
        ...
        <div class="row">
          ...
          <div class="col m2 s12 mb-3">
            <a href="{{route('tocChecklists')}}" class="btn cyan waves-effect waves-light right">Reset </a>
          </div>
        </div> 
   {{ Form::close() }}
      </div>
	  ...
	  <h4 class="header">&nbsp;<span style="color:blue;">Generate TOC Checklist AI Code Wise</span></h4>
        <div class="card-content">
             {!! Form::open(array('route' => 'downloadtocchecklistsPdf1','method'=>'POST')) !!}
            <div class="row">
              <div class="row">
        <div class="col m3 s12">
                @php $lbl='Ai code'; $placeholder = "Select ". $lbl; $fld='ai_code'; @endphp
   ...
   <div id="tap-target" class="card card-tabs">
        <div class="card-content">
		 <h4 class="header">&nbsp;<span style="color:green;">Bulk Download TOC Checklist </span></h4>
            <div class="row">
              <div class="col s12 center">
            
                <a href="{{ route('getDownloadtocchecklistzipdownload',[10,1,31]) }}" class="btn mt-2">Download TOC Checklist(Stream1-10th)</a>
                &nbsp;
                  <a href="{{ route('getDownloadtocchecklistzipdownload',[10,2,31]) }}" class="btn mt-2" >Download TOC Checklist(Stream2-10th)</a>
                &nbsp;
                </div>
                <div class="col s12 center">
                 <a href="{{ route('getDownloadtocchecklistzipdownload',[12,1,31]) }}" class="btn mt-2">Download TOC Checklist(Stream1-12th)</a>
                &nbsp;
                 <a href="{{ route('getDownloadtocchecklistzipdownload',[12,2,31]) }}" class="btn mt-2" >Download TOC Checklist(Stream2-12th)</a>
              </div>
            </div>
        </div>
      </div>
  ...
  <div id="tap-target" class="card card-tabs">
        <div class="card-content">
		 <h4 class="header">&nbsp;<span style="color:blue;">Bulk Generate Toc Checklist</span></h4>
            <div class="row">
              <div class="col s12 center">
               @foreach(@$exportBtn as $k => $v)
                @if($v['status'] == true)
                <a href="{{ route($v['url'],[10,1,0]) }}" class="btn mt-2">Generate TOC Checklist(Stream1-10th)</a>
                &nbsp;
                  <a href="{{ route($v['url'],[10,2,0]) }}" class="btn mt-2" >Generate TOC Checklist(Stream2-10th)</a>
                &nbsp;
                </div>
                <div class="col s12 center">
                 <a href="{{ route($v['url'],[12,1,0]) }}" class="btn mt-2">Generate TOC Checklist(Stream1-12th)</a>
                &nbsp;
                 <a href="{{ route($v['url'],[12,2,0]) }}" class="btn mt-2" >Generate TOC Checklist(Stream2-12th)</a>
             @endif
             @endforeach
              </div>
            </div>
