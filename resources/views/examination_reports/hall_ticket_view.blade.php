...
<body class="font">
	...
	@if(!empty(@$student['halltickectqrcode']))
						 <div class="mb-2" style='width:40px;margin-left:10px;'><?php echo @$halltickectqrcode = $student['halltickectqrcode']; ?></div>
						 @else
						<div class="mb-2" style='width:40px;margin-left:10px;'><?php echo @$halltickectqrcode; ?></div>
						 @endif					
						</td>
					</tr>
				</tbody>
												...
												<td>
													<div>
														...
														@if(!empty($student['photograph']))
															<img alt="image" src="{{asset('public/documents/'.$student['student_id'].'/'.$student['photograph'])}}" width="120px"  height="120px">
														@else
															 <img alt="image" height="120px" src="{{asset('public/app-assets/images/studentuser.png')}}" width="120px">  
														@endif
														</span> 
													</div>
													...
													<div>
														...
														<img alt="image" src="{{asset('public/documents/'.$student['student_id'].'/'.$student['signature'])}}" width="120px" style="max-height:50px;">
														@else
															 <img alt="image" height="20px" src="{{asset('public/app-assets/images/studentsignature.png')}}" width="120px">
														@endif
														</span>  
													</div>
												</td> 
