				...
				<div class="seaction">
					<div class="card">
						<div class="card-content">
							<h6>
								<a href="{{route('subjects.index')}}" class="btn btn-xs btn-info right">Back</a>
							</h6>
							<h6>Form Layouts</h6>
						</div>
					</div>
						...
						<div id="Form-advance" class="card card card-default scrollspy">
							<div class="card-content">
								<h4 class="card-title">Form Subjects</h4>
									{{ Form::open(['route' => 'subjects.store', 'method' => 'post','id' => $model]) }}
									{!! Form::token() !!}
										...
										<div class="row">
											<div class="col m3 s12">
												...
												<div class="input-field">{!! Form::select($fld,@$yes_no,null, ['class' => 'select2 browser-default form-control center-align ','placeholder' => $placeholder,]) !!}
												@include('elements.field_error')	
												</div>
											</div>
											<div class="col m3 s12">
											...
											<div class="col m3 s12">
												...
												<span class="small_lable">@php echo $lbl ; @endphp </span>
												<div class="input-field">
												{!! Form::select($fld,@$yes_no,null, ['class' => 'select2 browser-default form-control center-align ','placeholder' => $placeholder,]) !!}
												@include('elements.field_error')
												</div>
											</div>
											<div class="col m3 s12">
												@php $lbl='Is Commomn Faculty'; $placeholder = "Select ". $lbl; $fld='is_allow_faculty'; @endphp
												<span class="small_lable">@php echo $lbl ; @endphp </span>
												<div class="input-field">
												{!! Form::select($fld,@$yes_no,null, ['class' => 'select2 browser-default form-control center-align ','placeholder' => $placeholder,]) !!}
												@include('elements.field_error')
