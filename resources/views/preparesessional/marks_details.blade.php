											...
											@if(@$values['data'] && $values['data'] != null) 
												<div class="card">
													<div class="card-content invoice-print-area"> 
														<label style="font-size:20px;">@php echo $values['seciontLabel'];  @endphp </label>
														<div class="row">
											...
											<div id="Form-advance" class="card card card-default scrollspy">
												<div class="card-content">
													...
													<fieldset class="scheduler-border col-md-12 col-xs-12 left">
														...
														<label style="color:blue;font-size:16px;">
														<img class="" src="{{asset('public/app-assets/images/new.jpg')}}" height="20" alt="materialize logo"/>
														Note: In case the student is absent in the subject please enter AB in marks.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(नोट: यदि छात्र विषय में अनुपस्थित है तो कृपया अंकों में AB दर्ज करें।)</label>
														...
														@foreach($examSubjectsList as $subject_id => $marks) 
															...
															<div class="input-field2 col s12">
																...
																<div class="col s12"> 
																	...
																	<div class="col s2">
																		<div class="input-field2">
																			<h8> <b> @php echo @$minMarks[$subject_id]; @endphp </b></h8>
																		</div>
																	</div>
																	<div class="col s3">
																		<div class="input-field2">
																	...
																	<div class="col s3">
																		<div class="input-field2">
																			@php 
																				$value = @$examSubjectsList[$subject_id]; 
																				if(@$value == '999'){
																					@$value = "AB";
																				}
																			@endphp 
																			{!!Form::text($fld,@$value,['class'=>'form-control numold allowSpeChar sessional_marks', 'data-min' => $minMarks[$subject_id],  'data-max' =>  $maxMarks[$subject_id], 'required' => 'required' ,'maxlength'=> '2', 'minLength'=> '1','autocomplete'=>'off']); !!}
...
@endsection 
@section('customjs')
	<script src="{!! asset('public/app-assets/js/bladejs/prepare_sessional/marks_details.js') !!}"></script> 
@endsection 
