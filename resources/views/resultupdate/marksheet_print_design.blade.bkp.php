				...
				<tr>
					...
					<td> 
						<div style="background:red1;text-align:right;">
							...
							<!-- for barcode<div class="mb-2" style='width:92%;margin-right:20px;'>{{@$student['enrollment']}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>-->
						</div> 
					</td>
				</tr>
				<tr>
...
<td style="height:80px;">	
		<table width="100%" style="margin-left:5%;margin-top:25px;">
			<tr>
				...
				<div class="mb-2" style='width:40px;margin-left:0px;'>{{@$student['enrollment']}}</div>
				</div>
				</td>
			</tr>
			<tr>
