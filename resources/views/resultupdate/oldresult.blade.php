...
<div class="card">
	...
	<div id="tap-target" class="card card-tabs">
		<div class="card-content">
             {{ Form::open(['route' => [request()->route()->getAction()['as']], 'id' => 'oldresult','autocomplete'=>'off']) }}
				...
				<div class="row">
					<div class="step-actions right">
						...
						<div class="col s6 l4 m4 mb-3">
							<a href="{{route('resultprevious')}}" class="btn-small gradient-45deg-amber-amber" style="color: rgba(255, 255, 255, 0.901961);">Reset </a>
						</div>
						<div class="col s3 l4">
...
@endsection
@section('customjs')
    <script src="{!! asset('public/app-assets/js/bladejs/resultold_details.js') !!}"></script> 
@endsection 
