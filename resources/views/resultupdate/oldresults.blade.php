...
<div class="tab-content  bg-gray headsection">  
	<div class="row pad ">
		<div class="col-md-12">
			...
			@if(@$role_id && $role_id == $student_role_id)
			@else	
				<a href="{{ route('resultprevious') }}" class="button" style="text-decoration: none;color:white;background:linear-gradient(45deg,#6200ea,#1976d2)!important;">
					<i class="fa fa-search"></i> More Result Search
				</a>
			@endif	
				<a href="{{ route('oldresultdownloadpdf', ['enrollment' => $students->enrollment,'dob' => $students->dob]) }}" class="button" style="text-decoration: none;color:white;background:linear-gradient(45deg,#43a047,#1de9b6)!important;">
...
<center>
	...
	<span style="color:#00bcd4;font-size:20px;padding-top:0px;">
		 राजस्थान स्टेट ओपन स्कूल, जयपुर {{ @$getresultrsosyesrs[@$students->exam_year] }}
	</span>
</center>
<br>
