...
<div class="card">
    ...
    <span class="red-text">
		<b>
		   Note : For download the revised result please enter the mandatory fields.(परिणाम डाउनलोड करने के लिए कृपया अनिवार्य फ़ील्ड दर्ज करें।)
		</b>
	</span> 
	
	<div id="tap-target" class="card card-tabs">
		<div class="card-content">
             {{ Form::open(['route' => [request()->route()->getAction()['as']], 'id' => 'revisedresult','autocomplete'=>'off']) }}
            ...
            <div class="row">
				...
				<div class="row">
					<div class="right">
						...
						&nbsp;&nbsp;&nbsp;
						<a href="{{route('revisedresult')}}" class="btn-large gradient-45deg-amber-amber" style="color: rgba(255, 255, 255, 0.901961);">Reset </a>
					</div>
				</div> 
			{{ Form::close() }}
		</div>
...
@endsection
@section('customjs')
    <script src="{!! asset('public/app-assets/js/bladejs/result_revised_details.js') !!}"></script> 
@endsection 