...
<div class="card">
	...
	<div id="tap-target" class="card card-tabs">
		<div class="card-content">
             {{ Form::open(['route' => [request()->route()->getAction()['as']], 'id' => 'resultold','autocomplete'=>'off']) }}
            ...
            <div class="row">
				...
				<div class="row">
					<div class="right">
						...
						&nbsp;&nbsp;&nbsp;
						<a href="{{route('resultprevious')}}" class="btn-large gradient-45deg-amber-amber" style="color: rgba(255, 255, 255, 0.901961);">Reset </a>
					</div>
				</div> 
			{{ Form::close() }}
		</div>
