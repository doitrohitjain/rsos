...
<div class="tab-content  bg-gray headsection">  
	<div class="row pad ">
		<div class="col-md-12">
			...
			@endphp
				<a href="{{ route($routename) }}" class="button" style="text-decoration: none;color:white;background:linear-gradient(45deg,#6200ea,#1976d2)!important;">
					<i class="fa fa-search"></i> More Result Search
				</a>
				
				<a href="{{ route('resultdownloadpdf', ['enrollment' => $students->enrollment,'dob' => $students->dob]) }}" class="button" style="text-decoration: none;color:white;background:linear-gradient(45deg,#43a047,#1de9b6)!important;">
					<i class="fa fa-search"></i>Download Marksheet
				</a>
