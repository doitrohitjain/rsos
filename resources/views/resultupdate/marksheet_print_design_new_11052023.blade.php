...
<table width="100%" style="margin-top:0px;" >
	<tr>
		<td style="height:90px;padding-top:5px;">	
			<table width="100%" style="margin-left:5%;margin-top:0px;">
				...
				<tr>
					<td width="33%" style="vertical-align:middle;padding-left:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- AI No. --> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="bigfontset18px"><?php echo @$student['ai_code'];?></span></td>
	...
	<table id="example4" class="table2 table-bordered2 bigfontset18px" role="grid2" width="100%" 
	style="margin-left:0%;margin-top:15px;height:30px !important;">
	...
	<tr><td style="height:30px !important;">
	...
	<?php }*/?>					
			<table width="100%" style="height:30px;margin-top:12px;" >
			<tr>
				...
				?>
				<img src="{{$secratory_sign}}" style="width:70px" align="center"/></br><b>RAJENDRA KUMAR SHARMA</b></td>
				<td width="40%" style="text-align:center;padding-right:30px;" ><img src="{{$director_sign}}" style="width:70px" align="center"/></br><b>PRAVEEN KUMAR LEKHARA</b></td>
...
<td style="height:80px;">	
	...
	<!--<tr><td style="height:50px;">&nbsp;</td></tr>-->
	<tr><td>
	<table id="example4" class="table2 table-bordered2 bigfontset18px" role="grid2" width="92%" style="margin-left:4%;margin-top:45px;">
			<tr style="font-weight:bold;">
