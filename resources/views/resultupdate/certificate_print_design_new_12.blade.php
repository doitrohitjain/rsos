...
<table class="maintbl" width="100%" style="page-break-after:always;z-index:-999;background-image:url('http://10.68.181.175:8080/lrsos/public/app-assets/images/watermark.png');">
	...
	<img src="{{asset('public/app-assets/images/martoplgreen.png')}}" style="position:absolute;z-index:9;margin:-5px 0px 0px 0px !important;" width="150px" height="130px"  align="left"/>	
	<table width="77%" style="float:left;margin-top:4%;margin-left:8%;z-index:1;">
		...
		<img src="{{asset('public/app-assets/images/martoprgreen.png')}}" style="float:left;position:absolute;z-index:9;margin:-5px 0px 0px 0px !important;" width="150px" height="130px"  align="left"/>	
		</td>
	</tr>
	<tr><td>
		<table width="100%">
			<tr>
				...
				<img src="{{asset('public/app-assets/images/marksheet_name_green.png')}}" style="width:85%;" align="center"/>
				</td>
			</tr>			
			...
			<tr><td class="bigfontsetmigration" colspan="3" style="text-align:center;color:green;font-size:32px;">माइग्रेशन एवं स्थानान्तरण प्रमाण पत्र</td></tr>
			<tr><td class="bigfontsetmigration" colspan="3" style="text-align:center;color:green;font-size:26px;">Migration Cum Transfer Certificate</td></tr>
		</table>
	</td>
	</tr>
	<tr>
			...
			<tr>
				<td width="90%">
					<table width="100%" style="margin-left:1%;">
						...
						<tr>
							<td colspan=2 style="width:100%;height:50px;"><span class="fontbody" >This institution has no objection to his/her joining any recognized</span></td>
	...
	<tr>
		<td>
		<img src="{{asset('public/app-assets/images/marbotlgreen.png')}}" style="position:absolute;z-index:9;rotate:360deg;margin:0px 0px 0px 0px;" width="150px" height="130px"  align="left"/>	
		<table width="71%" style="text-align:center;float:left;margin:2% 0% 0% 14%;">
		  ...
		  <img src="{{asset('public/app-assets/images/marbotrgreen.png')}}" style="float:eft;position:absolute;z-index:9;margin:0px 0px 0px 0px;" width="150px" height="130px"  align="left"/>
		  </td>
	</tr>
</table>
<?php }else{
