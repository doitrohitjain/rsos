...
<table width="100%">
	        ...
	        <table width="100%"><tr><td style="width:95%;">
				<table id="pdetail" width="100%">
					<tr>
						...
						<td class="bigfontset18px" style="padding-top:20px;padding-left:210px;"><span>
	...
	<tr><td style="height:128px;padding-top:5px;">&nbsp;</td></tr>
	<tr>
	...
	<tbody>				   
						<?php 
							...
							foreach($examSubjectsMarksData as $key=>$val){
								...
								echo "<td style='' height='25px;' width='510px;' >".$subjects[$val['subject_id']]."</td>";
								echo "<td width='95px' style='padding-left:10px;'>";
								...
								echo "<td width='80px' style='padding-left:20px;'>";
									 ...
									 echo "</td>";
									echo "<td width='75px' style='padding-left:30px;'>";
...
<td style="height:80px;">	
	...
	<tr>
	<td class="bigfontset18px" style="height:210px;padding:0px;vertical-align:top;">
	<table id="example4" class="table2 table-bordered2 bigfontset18px" role="grid2" width="92%" style="margin:0px;vertical-align:top;width:100%;">
	<tbody style=''>				   
						<?php 
							$r = 1;
							...
							foreach(@$examSubjectsMarksData as $key=>$val){
								...
								echo "<td width='95px' style='padding-left:5px;'>";
								echo $val['max_marks'];
								echo "</td>";
								echo "<td width='100px' style='padding-left:20px;'>";
								if(@$resultsyntax[$val['final_theory_marks']])
								...
								echo "<td width='80px' style='padding-left:20px;'>";
									...
									echo "</td>";
									echo "<td width='120px' style='padding-left:0px;'>";
									if(@$resultsyntax[$val['total_marks']])
									{echo @$resultsyntax[$val['total_marks']];}
									else{echo @$val['total_marks'];}
									echo  "</td>";									
									echo "<td width='255px' style='padding-left:10px;'>";
									if(isset($val['num_words'])){ 
										echo $val['num_words']; 
									}
									echo "</td>";
	...
	<!--<tr><td style="height:50px;">&nbsp;</td></tr>-->
	<tr><td>
	<table id="example4" class="table2 table-bordered2 bigfontset18px" role="grid2" width="92%" style="margin-left:4%;margin-top:85px;">
			<tr style="font-weight:bold;">
