...
<div class="tab-content  bg-gray headsection">  
	<div class="row pad ">
		<div class="col-md-12">
			<div class="col-sm-2 font"style="text-align: right;">
			
			@php
				$routename=null; 
				if(Route::currentRouteName() == 'direct_provisioanl_marksheet'){
					$routename='direct_provisional_results';
				}else{
					$routename='result';
				}
			@endphp
				<a href="{{ route('view_result') }}" class="button" style="text-decoration: none;color:white;background:linear-gradient(45deg,#6200ea,#1976d2)!important;">
					<i class="fa fa-search"></i> More Result Search
				</a>
				
				<a href="javascript:void(0)" class="button" id="printResult" onclick="window.print();" style="text-decoration: none;color:white;background:linear-gradient(45deg,#43a047,#1de9b6)!important;">
					<i class="fa fa-search"></i>Print Marksheet
				</a>
...
<center>
	...
	<span style="color:#00bcd4;font-size:20px;padding-top:0px;">
		राजस्थान स्टेट ओपन स्कूल, जयपुर @php //echo Config::get('global.siteTitle'); @endphp
	</span>
</center>
<br>
	...
	<div class="box box-warning2 box-solid " id="printarea"> 
		<div id="hallticketdownloadform" class="row pad "><?php 
					if(isset($students) && !empty($students)){
						...
						<div class="row pad">
							<div class="col-sm-12 font" style="font-size:14px;">
							<div class="col-sm-12 text-center font">
								<center>
									...
									<span class="font">@if($students->course == 10)
										...
										@endif
										<b>{{ @$result_session }}</b><h4 class="font" style="padding: 3; margin:3;">Provisional Marksheet</h4></span>
								...
								<tr>
									<th>RESULT</th> 
										...
										<th style="font-size:25px;color:red;">
											<b>
												<?php echo @$students->final_result?>
											</b>
										</th>
									<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
									</tr>
					...
					<div class="row pad">
						<div class="col-sm-offset-0 col-sm-12 font" style="font-size:12px;">
							...
							Note: 
							<br>						
						    1. Last date for applying for Retotalling is 28th January 2025.
							<br>
							2. Student have to apply for Retotalling by login into Student Dashboard using SSO Portal.
							@endif
					</p>
	...
	<?php  $enrollment=@$students->enrollment; ?>
	...
	<script> 
		...
		$("#printResult").on("click", triggerPrintAction);

		function triggerPrintAction() {
			const enrollment = "<?php echo $enrollment; ?>";
			const csrfToken = $('meta[name="csrf_token"]').attr('content');

			$.ajax({
				url: "{{route('printscreen')}}",
				type: "POST",
