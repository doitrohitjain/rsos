	...
	<div class="row pad ">
		<div class="col-md-12">
			...
			@endphp
				...
				<a href="javascript:void(0)" class="button" id="printResult" style="text-decoration: none;color:white;background:linear-gradient(45deg,#43a047,#1de9b6)!important;">
		...
		<div id="hallticketdownloadform" class="row pad "><?php 
					...
					<div class="row pad">
						<div class="col-sm-offset-0 col-sm-12 font" style="font-size:12px;">
							...
							Note: 
							<br>						
						    1. Last date for applying for Retotalling is 25th January 2025.
							<br>
