				...
				<tr>
					...
					<td> 
						<div style="background:red1;text-align:right;">
							<div class="mb-2" style="width:100%;text-align:center;margin-left:75px;"><?php echo $barcode_img ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
							<div class="mb-2" style='width:92%;margin-right:20px;font-size:10px;'>{{@$student['enrollment']}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
						</div> 
					</td>
				</tr>
				<tr>
	...
	<tr>
	    ...
	    <td style="height:50px;padding-top:0px;">
	        <table style="height:50px;margin-top:5px;">
				...
				<tr>
					<td class="bigfontset18px" style="padding:0px 0px 0px 385px;height:25px;">
					    {{@$student['display_exam_month_year']}}<!-- APR-MAY 2020-->
					</td>
			    </tr>
	        </table>
	 ...
	 <tr><td style="height:105px;padding-top:5px;">&nbsp;</td></tr>
	<tr>
	...
	<?php }*/?>					
			<table width="100%" style="height:30px;" >
				<tr >
					...
					?>
					<img src="{{$secratory_sign}}" style="width:70px" align="center"/></br><b>{{strtoupper(@$secratory_signature)}}</b></td>
					<td width="40%" style="text-align:center;padding-right:30px;padding-bottom:10px;vertical-align:bottom;" ><img src="{{$director_sign}}" style="width:70px" align="center"/></br><b>{{strtoupper(@$director_signature)}}</b></td>
				...
				<tr>
					<td width="12%"></td>
					<td width="38%" class="bigfontset" style="padding-right:6px;"><br>&nbsp;&nbsp;&nbsp;<b>{{$resultDate}}</b> </td>
					<td width="50%">&nbsp;</td>
				</tr>
	       </table>
	</td></tr>
...
<td style="height:80px;">	
		<table width="100%" style="margin-left:5%;margin-top:25px;">
			<tr>
				...
				<div class="mb-2" style='width:40px;text-align:center;margin-left:20px;'><?php echo @$barcode_img; ?></div>
				<div class="mb-2" style='width:40px;text-align:center;margin-left: 17px;font-size:10px;'>{{@$student['enrollment']}}</div>
				</div>
				</td>
			</tr>
			<tr>
	...
	<table width="100%" style="text-align:center;margin:40px 0px 0px 80px;">
		<tfoot>
			...
			<tr>
				<td width="50%">&nbsp;</td>
				<td width="50%" style="padding-left:0px;text-align:left;"><b>{{strtoupper(@$secratory_signature)}}</b> <!-- Secratray Sign --></td>
