            ...
            <div class="container">
                <div class="section">
                    <div class="col s12 m12 l12">
                        <div class="card"> @include('elements.sessional_top_navigation') </div>
                    </div>
                        ...
                        <div id="Form-advance" class="card card card-default scrollspy">
                            <div class="card-content">
                                <h5 class="card-title2">{{ $page_title; }}
									<span>
										<a href="{{ route('find_enrollment') }}" class="waves-effect waves-teal btn gradient-45deg-deep-orange-orange white-text secondary-content">Search More Enrollment</a>
									</span>	
								</h5>
...
@endsection 
@section('customjs')
	<script src="{!! asset('public/app-assets/js/bladejs/marks_preview_details.js') !!}"></script> 
@endsection 
