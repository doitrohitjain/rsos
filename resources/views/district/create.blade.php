          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add District</span></h5>
              </div>
              <div class="col s12 m6 l6 right-align-md">
                <ol class="breadcrumbs mb-0">
                 <li class="breadcrumb-item"><a href="index-2.html">Home</a>
                  ...
                  <li class="breadcrumb-item active">Add District
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="card-content">
          ...
          {!! Form::token() !!}
            <div class="row">
              ...
              {!! Form::select('state_id',$state, null, ['class' => 'form-control', 'placeholder' => 'Please Select State']) !!}
              @error('state_id')
              ...
              <div class="input-field col m6 s12">
			   @php $lbl="डिवीजन (Division)"; $fld='division_id'; @endphp 
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
              {!!Form::text('division_id',old('division_id'),['type'=>'text','class'=>'form-control','autocomplete'=>'off']); !!}
				       @error('division_id')
                <span class="invalid-feedback" role="alert" style="color:red;">
                      <strong>{{ $message }}</strong>
                  </span>
			 ...
			 <div class="row">
              <div class="input-field col m6 s12">
			   @php $lbl="कोड(Code)"; $fld='code'; @endphp 
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
              {!! Form::text('code',old('code'),['type'=>'text','class'=>'form-control','autocomplete'=>'off']); !!} 
			    @error('code')
                <span class="invalid-feedback" role="alert" style="color:red;">
                      <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="input-field col m6 s12">
               @php $lbl="नाम(Name)"; $fld='name'; @endphp 
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
              {!! Form::text('name',old('name'),['type'=>'text','class'=>'form-control','autocomplete'=>'off']); !!}
              @error('name')
                <span class="invalid-feedback" role="alert" style="color:red;">
                      <strong>{{ $message }}</strong>
                  </span>
			 ...
			 <div class="row">
              <div class="input-field col m6 s12">
				...
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
              {!! Form::text('name_mangal',old('name_mangal'),['type'=>'text','class'=>'form-control','autocomplete'=>'off']); !!}
             @error('name_mangal')
                <span class="invalid-feedback" role="alert" style="color:red;">
                      <strong>{{ $message }}</strong>
                  </span>
