 ...
 <div id="main">
  ...
  <div class="card">
    <div class="card-content">
      <p class="caption mb-0"><h6>{{ $title; }} <span style="margin-left: 85%;"><a href="{{ route('deo') }}" class="btn btn-xs btn-info pull-right">Back</a></span>
<h6></p>
    </div>
  </div>
  <!-- Page Length Options -->
      ...
      <div class="card">
        <div class="card-content">
			<div class="row">
				...
				<div class="input-field col s6">
					@php $lbl='चयन जिला (district):';$fld='district_name'; @endphp
					<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
					<br>@php echo @$master->$fld @endphp 
				</div> 
