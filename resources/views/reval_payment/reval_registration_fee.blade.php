							...
							<div id="Form-advance" class="card card card-default scrollspy">
								...
								<div class="card-content">
									...
									<div class="card-content">
										...
										<?php 
										if(@$student->reval_students->challan_tid && $student->reval_students->challan_tid != ""){ ?>
											<?php 
												if(@$student->reval_students->locksumbitted && @$student->locksubmitted_date){  ?>
													<div class="">
														<p style="color:green;font-size:22px;">
															...
															(After payment, you download the revaluation  application's form pdf format.)
														</p>
														...
														style ="" 
														href="{{ route('reval_generate_student_pdf',Crypt::encrypt(@$student->student_id)) }}">
															Download Revaluation Payment PDF
														</a> 
														<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange" 
														style ="" 
														href="{{ route('landing') }}">
									...
									<div class="row">
										...
										<div class="input-field col s4">
											...
											<h8>
												...
												@php 
													...
													$withoutLateFee = $student->reval_students->$fldTotal - $student->reval_students->$fldLateFee;
													echo $withoutLateFee . "/-";
												@endphp
											</span>
											</h8>
										...
										@if($student->reval_students->$fldLateFee > 0)
											<div class="input-field col s4">
												@php $lbl="Late Fees"; $fld='late_fees'; @endphp
												<h8>
													<span style="color:red;font-size: 25px;">
														{!!Form::label($fld, $lbl,array('style' => 'font-size: 25px;color:red;')) !!}
													{!! $student->reval_students->$fld .  "/-" !!}
												</span>
												</h8>
											</div> 
										@endif
									...
									<div class="row">
										...
										<div class="input-field col s8" style="font-size:16px;">
											@php 
												$lbl = __('Grand Total of Revaluation Form filling <b><u> Fee Payment Amount</b></u>'); $lblhi = __('(पूरक आवेदन पत्र भरने का शुल्क <b><u>भुगतान राशि का कुल योग</b></u>)');
												$fld='application_fee'; 
											@endphp 
								...
								<!-- Fee payment button start -->
									<div class="card-content">
										...
										@if( $student->reval_students->challan_tid == "")
										...
										<div class="card-content">
											<?php  
												if($isAlreadyRaisedRequest > 0 && $student->reval_students->challan_tid == "" ){ ?>
											<br/>
											<hr/>
											<img class="" src="{{asset('public/app-assets/images/new.jpg')}}" height="40" alt="materialize logo"/>
											...
											<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange" 
											style ="" href="{{ route('reval_verify_request',Crypt::encrypt(@$student->enrollment)) }}">
												Verify Your Payment
											</a> 
											...
											if( $issueCount <= 0){ ?>
												...
												In case you want to raise a request to admin for your transaction got failed, please click on the raise a request button.
													...
													<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange"  href="{{ route('reval_raise_request',Crypt::encrypt(@$student->enrollment)) }}">
