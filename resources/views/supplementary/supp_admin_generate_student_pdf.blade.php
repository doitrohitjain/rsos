...
<table border="1" style="width:100%;">
	     @if(@$suppchangerequeststudentgetdate > 0)
		 @foreach ($suppchangerequeststudentgetdatachangerequests as $user)
		<tr>
			...
			<td style="font-size:18px; border: 1px solid #dddddd; text-align: left; padding: 8px;">&nbsp; Change Request Amount</td>
		</tr>
		<tr>
			
			<td style="font-size:18px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;{{@$user->challan_tid}}</td>
			<td style="font-size:18px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;{{@$user->updated_at}}</td>
			<td style="font-size:18px; border: 1px solid #dddddd; text-align: left; padding: 8px;"> &nbsp;{{@$user->amount}}</td>
