							...
							<div id="Form-advance" class="card card card-default scrollspy">
								...
								<div class="card-content">
												...
												if(@$student->locksumbitted && @$student->locksubmitted_date){  ?>
													<div class="">
														<p style="color:green;font-size:22px;">
															...
															(After payment, you download the supplementary application's form pdf format.)
														</p>
														...
														href="{{ route('supp_generate_student_pdf',Crypt::encrypt(@$student->student_id)) }}">
															Download Supplementary Payment PDF
														</a> 
														<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange" 
														style ="" 
														href="{{ route('supplementary_student_applications') }}">
															Back
														</a> 
													</div> 
											<?php }  ?>
									...
									<div class="row">
                                        ...
                                        <div class="input-field col s4">
											<span style="opacity:.6;">Verification Status</span>
											<h8>
											@if($student->is_department_verify == 2 && $student->is_aicenter_verify == 2)
												
		                                      <span style="font-weight:bold;"> Approved</span>
	                                        @else
											<span style="font-weight:bold;"> Not Approved</span> 
											</h8>
											@endif
										</div> 
										...
										<div class="input-field col s4">
											...
											<h8>
												...
												@php 
													...
													$withoutLateFee = $student->$fldTotal - $student->$fldLateFee;
													echo $withoutLateFee . "/-";
												@endphp
											</span>
											</h8>
									...
									<div class="row">
										...
										<div class="input-field col s8" style="font-size:16px;">
											@php 
												$lbl = __('Grand Total of Supplementary Form filling <b><u> Fee Payment Amount</b></u>'); $lblhi = __('(पूरक आवेदन पत्र भरने का शुल्क <b><u>भुगतान राशि का कुल योग</b></u>)');
												$fld='application_fee'; 
											@endphp 
								...
								<!-- Fee payment button start -->
									<div class="card-content">
										...
										<div class="card-content">
											...
											<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange" 
											style ="" href="{{ route('supp_verify_request',Crypt::encrypt(@$student->enrollment)) }}">
												Verify Your Payment
											</a> 
											...
											if( $issueCount <= 0){ ?>
												...
												In case you want to raise a request to admin for your transaction got failed, please click on the raise a request button.
													...
													<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange"  href="{{ route('supp_raise_request',Crypt::encrypt(@$student->enrollment)) }}">
...
@section('customjs')
	<script src="{!! asset('public/app-assets/js/bladejs/supp_payment/supp_registration_fee.js') !!}"></script> 
@endsection