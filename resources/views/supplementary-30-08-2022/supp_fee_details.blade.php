									...
									<div class="row">
										...
										<div class="col s10">
											<table class="responsive-table">
												...
												<tbody>
													<tr>
														<td style ="font-weight: bold;color:black;">@php $fld="Fees Details"; echo "<b>". ucwords(str_replace("_", " ", $fld)) . "</b>";  @endphp</td>
														<td style="color:black;"><b>RS.</b></td>
													</tr>
													<tr>
														<td>@php $fld="subject_change_fees"; echo ucwords(str_replace("_", " ", $fld)); @endphp</td>
														<td>{{  @$master[$fld]}}</td>
													</tr>
													<tr>
														<td>@php $fld="exam_subject_fees"; echo ucwords(str_replace("_", " ", $fld)); @endphp</td>
														<td>{{  @$master[$fld]}}</td>
													</tr>
													<tr>
													...
													<tr>
														<td>@php $fld="late_fees"; echo ucwords(str_replace("_", " ", $fld)); @endphp</td>
														<td>{{  @$master[$fld]}}</td>
													</tr>
													<tr>
