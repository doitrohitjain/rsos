								...
								<div class="card-content">
									...
									<div class="row">
						               <div class="input-field col s6">
											...
											{!!Form::text($fld,@$master->$fld,['class'=>'form-control from_date','autocomplete'=>'off','readonly'=>'readonly']); !!}
											@include('elements.field_error')
										</div>
										<div class="input-field col s6">
											@php $lbl='To Date'; $fld='to_date'; @endphp
											<h8>{!!Form::label($fld, $lbl) !!}</h8>
											{!!Form::text($fld,@$master->$fld,['type'=>'text','class'=>'form-control to_date','autocomplete'=>'off','readonly'=>'readonly']); !!}
											@include('elements.field_error')
										</div>
									</div>
