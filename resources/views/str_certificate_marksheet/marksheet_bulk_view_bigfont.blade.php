<?php use App\Component\CustomComponent; 
	...
	<table class="" style="width:100%;font-size:10px;border:1px thin #000;">
	<thead>
		<tr>
			<th colspan="2" ><h2 style="font-size:18px;font-weight:bold;text-align:left;width:150px !important;margin-left:2px !important"><b>AI Code:<?php echo $ai_code; ?></b></h2></th>
			<th colspan="3" ><h2 style="font-size:18px;font-weight:bold;text-align:left;margin-left:2px !important"><b>Result Date: 24-08-2022</b></h2></th>
		</tr>
		<tr>
	...
	foreach(@$dataSave as $value){ 
		...
		if(isset($value['enrollment'])){
			...
			?>
				<tr>
					<td style='text-align:center;width:50px'><div style='text-align:center;width:40px !important'><?php  echo $count . ".</div><br>";  
					...
					<td style="font-size:14px;width:120px !important;text-align:center;">
...
<style> .font{ font-family: Arial; } table { border-collapse: collapse; border-spacing: 0; } .table-bordered, th, tr, td { border: 1px solid grey !important;text-align : left !important; } </style>