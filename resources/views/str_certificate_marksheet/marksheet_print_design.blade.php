		...
		<td style="height:90px;padding-top:10px;">	
			<table width="100%" style="margin-left:5%;margin-top:0px;">
				...
				<tr>
					...
					<td style="vertical-align:top;padding-top:5px;"><span class="bigfontset18px"><!-- Revised --> <?php echo $marksheet_type; ?><!--Issued On 09-02-2021--><?php echo date('d-m-Y');?></span></td>
				</tr>
			</table>
		</td>
	</tr>	
	...
	<table width="100%" style="text-align:center;">
		<tfoot>
			...
			<tr>
				...
				<td width="35%" style="padding-left:30px;"><img src="{{asset('public/app-assets/images/favicon/DirectorSign1.png')}}" style="width: 70px;" align="center"/></td>
...
<td style="height:80px;">
		<table width="100%" style="margin-left:5%;margin-top:10px;">
			<tr>
				<td width="33%" class="bigfont" style="padding-top:0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- Serial No: --> <span class="bigfontset18px"> <?php
				if(isset($serial_number)){
					echo $serial_number;
				}
				?> <span></td>
						...
						<?php 
							...
							foreach(@$examSubjectsMarksData as $key=>$val){
								...
								echo "<td width='80px' style='padding-left:20px;'>";
									...
									echo "</td>";
									echo "<td width='130px' style='padding-right:10px;text-align:right;'>";
									if(@$resultsyntax[$val['total_marks']])
									{echo @$resultsyntax[$val['total_marks']];}
									else{echo @$val['total_marks'];}
									echo  "</td>";									
	...
	<!--<tr><td style="height:50px;">&nbsp;</td></tr>-->
	<tr><td>
	<table id="example4" class="table2 table-bordered2 bigfontset18px" role="grid2" width="92%" style="margin-left:4%;margin-top:180px;">
			<tr style="font-weight:bold;">
