										...
										<tr>
											...
											<td>
												@php 
													...
													$total = $custom_helper_obj->_getStudentAiCodeWise($ai_code);
													echo $total;
												@endphp	
											</td>
											<td>
												@php
													$totalLocked = $custom_helper_obj->_getStudentLockSubmttedAiCodeWise($ai_code);
													echo $totalLocked;
												@endphp	
											</td>
											<td>
											...
											<td>
												@php
													$totalFeePaid = $custom_helper_obj->_getStudentFeePaidAiCodeWise($ai_code);
													echo $totalFeePaid;
												@endphp	
											</td>
										</tr>
