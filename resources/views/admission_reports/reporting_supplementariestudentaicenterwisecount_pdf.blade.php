                    ...
                    <tr>
                      ...
                      <td>
                        @php 
                          ...
                          $total = $custom_helper_obj->_getStudentSupplementaryAiCodeWise($item->ai_code);
                          echo $total;
                        @endphp 
                      </td>
                      <td>
                        @php
                          $totalLocked = $custom_helper_obj->_getSupplementaryStudentLockSubmttedAiCodeWise($item->ai_code);
                          echo $totalLocked;
                        @endphp 
                      </td>
                      <td>
                      ...
                      <td>
                        @php
                          $totalFeePaid = $custom_helper_obj->_getSupplementaryStudentFeePaidAiCodeWise($item->ai_code);
                          echo $totalFeePaid;
                        @endphp 
                      </td>
                      <td>
