            ...
            <div class="col s12">
                <div class="container">
                    <div class="seaction">
                        ...
                        @endif
                        @if(@$changeRequestStatus == 2 && @$changerequeststudentsdataid->student_update_application == 1)
                            <div class="card">
                                <div class="card-content">
                                    <p class="caption mb-0">
							<span style="color:red;font-size:20px;">
                            @php
                                echo Config::get('global.student_change_request_notification');
                            @endphp
                           </span>
                                    </p>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <h3>
                                        <center style='gradient-45deg-deep-orange-orange;'>
                                            <b>Welcome,{{Auth::guard('student')->user()->name;}}</b></center>
                                    </h3>
                                    ...
                                    if (@$studentallowornot && $studentallowornot == true && @$changeRequestStatus == null) {
                                    ...
                                    } elseif (@$changeRequestStatus == null && @ Auth::guard('student')->user()->update_change_requests_challan_tid == null) {
                                    ...
                                    if (@$dateIsOpen && $dateIsOpen == true && @$isFinallyRejectedByDept) {
                                        ...
                                        // dd($isAllowUploadForFreshAfterRemoveUnwanterRejectedDocInputs);
//                                        dd($dateIsOpen);
                                        if (@$dateIsOpen && $dateIsOpen == true && $getCurrentFreshVerifydata !== null && @$isAllowUploadForFreshAfterRemoveUnwanterRejectedDocInputs) {
                                    ...
                                    */
                                    if (@$isAllowForRevalApplicaitonForm == true) {
                                        $btnLbl = " Apply ";
                                    ...
                                    if (
                                        (@$isAllowForSuppApplicaitonForm && $isAllowForSuppApplicaitonForm == true && @$getsupplementarychangerequertstudentdatas->supp_student_change_requests == null)
                                        ||
                                        (@$isAllowForSuppApplicaitonForm && $isAllowForSuppApplicaitonForm == true && @$getsupplementarychangerequertstudentdatas->supp_student_update_application == null)
                                    ) {
                                        ...
                                        @if(@$checkchangerequestsAllowOrNotAllow == true)
                                            @can('student_change_requests')
                                                    ...
                                                    if (@$changerequeststreamgatdata->option_val == 3) {
                                                        if (@$changeRequestStatus == 1 && Auth::guard('student')->user()->can('student_change_request_status')) {
                                                        ...
                                                        } elseif (@$changeRequestStatus == 2 && Auth::guard('student')->user()->can('student_change_request_update_application_button')) {
                                                            ...
                                                            if (@$changerequeststudentgetdatecount > 0) {
                                                                $lists[] = array('lbl_text' => 'आप आवेदन पत्र में  परिवर्तन के लिए  केवल एक बार आवेदन कर सकते हैं!(You can apply for changes in the application form only once).', 'is_new' => true,);
                                                            } else {
                                                                $path = route('student_change_requests', Crypt::encrypt(@$student_id));
                                                                $lists[] = array('lbl_text' => 'आप आवेदन पत्र में  परिवर्तन के लिए  केवल एक बार आवेदन कर सकते हैं  अपने आवेदन पत्र में अपडेट करने के लिए "Change Request" बटन पर क्लिक करें। (You can apply for changes in the application form only once. To update your application form , click on "Change Request" button )', 'btnText' => 'Change Request', 'is_new' => true, 'route' => $path);
                                                            }
                                                        ...
                                                        if (@$changeRequestStatus == 1 && Auth::guard('student')->user()->exam_month == @$changerequeststreamgatdata->option_val && Auth::guard('student')->user()->can('student_change_request_status')) {
                                                            $lists[] = array('lbl_text' => 'आपके द्वारा आवेदन फॉर्म को अपडेट करने के लिए अनुरोध कर दिया गया है।(You have requested to update your application form).', 'is_new' => true,);
                                                        } elseif (@$changeRequestStatus == 2 && @$changerequeststudentsdataid->exam_month == @$changerequeststreamgatdata->option_val && Auth::guard('student')->user()->can('student_change_request_update_application_button')) {
                                                            $path = route('student_change_requests_update_application', Crypt::encrypt(@$student_id));
                                                            $lists[] = array('lbl_text' => 'अपने आवेदन पत्र में अपडेट के लिए  "Update Application" बटन पर क्लिक करें(Click on "Update Application" button for update in your application form)', 'btnText' => 'Update Application', 'is_new' => true, 'route' => $path);
                                    ...
                                    @if(@$chnagerequestsupplementariesallowIps == true)
                                        @if(@$checkchangerequestsssupplementariesAllowOrNotAllow == true)
                                            @can('supp_student_change_requests')
                                                    ...
                                                    } elseif (@$getsupplementarychangerequertdatas > 0 && Auth::guard('student')->user()->can('supp_student_change_request_button')) {
														
													   if(@$suppchangerequeststudentmorecount > 0){
														  $lists[] = array('lbl_text' => 'आप आवेदन पत्र में  परिवर्तन के लिए  केवल एक बार आवेदन कर सकते हैं!(You can apply for changes in the application form only once).', 'is_new' => true,);  
													   }else{
                                    ...
                                    @else
                                        <center>
                                            <img src="data:image/jpeg;base64,"
                                                 data-deferred="1" class="rg_i Q4LuWd" jsname="Q4LuWd" width="400"
                                                 height="290" alt="Practice sets - The Keyword"
                                                 data-iml="914.8000000007451" data-atf="true">
                                        </center>
                                    @endif
