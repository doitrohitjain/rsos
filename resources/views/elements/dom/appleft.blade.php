@php 
	...
	$reval_exam_month = $custom_component_obj->_getRevalExamMonth();
	$resultCount = 0;
	if(@$changerole){
		$resultCount = count($changerole); 
	}
    $student_role=Config::get("global.student");
	$stream_id = config("global.defaultStreamId");
	$supp_stream_id = config("global.supp_current_admission_exam_month");
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
	<div class="brand-sidebar">
	 ...
	 <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
		...
		@if(in_array("update_my_profile",$permissions)) 
			<li class="bold">
				<a class="{{ (Request::routeIs('update_my_profile') ? 'active' : '')}}" href="{{route('update_my_profile')}}"><i class="material-icons"> local_library</i><span class="menu-title" data-i18n="Mail">My Profile</span></a>
			</li>
		@endif
		...
		@if(in_array("all_dashboard",$permissions))
			<li class="{{ (Request::routeIs('deodashboard') ? 'active' : '') || (Request::routeIs('applicationdashboard') ? 'active' : '') || (Request::routeIs('admindashboard') ? 'active' : '') || (Request::routeIs('studentdashboard') ? 'active' : '') || (Request::routeIs('collegedashboard') ? 'active' : '') ||
				...
				(Request::routeIs('preparesessionaldashboard') ? 'active' : '') ||
				...
				(Request::routeIs('examination_admin') ? 'active' : '') || 
				(Request::routeIs('application_verifier_admin_dashboard') ? 'active' : '') || 
				(Request::routeIs('examination_department') ? 'active' : '') ||
				(Request::routeIs('marksheetverificationdashboard') ? 'active' : '') ||
				(Request::routeIs('secrecydashboard') ? 'active' : '') || (Request::routeIs('publication_dept') ? 'active' : '') ||
				(Request::routeIs('evaluationdashboard') ? 'active' : '') || (Request::routeIs('users.*') ? 'active' : '') || (Request::routeIs('theroyexaminerdashboard') ? 'active' : '') || (Request::routeIs('colleges.*') ? 'active' : '') || (Request::routeIs('deodashboard') ? 'active' : '') || (Request::routeIs('permissions.*') ? 'active' : '') || (Request::routeIs('dgs_dashboard') ? 'active' : '')
				...
				<a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Mail">My Dashboard </span></a>
					<div class="collapsible-body">
						<ul class="collapsible collapsible-sub" data-collapsible="accordion">
							...
							<li class="active bold"><a class="{{ (Request::routeIs('dgs_dashboard') ? 'active' : '') }}" href="{{route('dgs_dashboard')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Dgs Dashboard</span></a>
								</li>
							@endif
							
							@if(in_array("marksheet_verification_dashboard",$permissions))
							<li class="active bold"><a class="{{ (Request::routeIs('marksheetverificationdashboard') ? 'active' : '') }}" href="{{route('marksheetverificationdashboard')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard"><span style="font-sizeold:10px;">Result Verifier Dash. </span></span></a>
								</li>
							@endif 
						...
						@endif
							...
							@if(in_array("prepare_sessional_student_dashboard",$permissions))
								<li class="active bold"><a class="{{ (Request::routeIs('preparesessionaldashboard') ? 'active' : '') }}" href="{{route('preparesessionaldashboard')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Sessional Dashboard</span></a>
								</li>
							@endif
							...
							@if(in_array("publication_dept_dashboard",$permissions))
							<li class="active bold"><a class="{{ (Request::routeIs('publication_dept') ? 'active' : '') }}" href="{{route('publication_dept')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Publication Dashboard</span></a>
							</li>
							@endif 
							
							@if(in_array("examination_admin",$permissions))
							<li class="active bold"><a class="{{ (Request::routeIs('examination_admin') ? 'active' : '') }}" href="{{route('examination_admin')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Examination Dashboard</span></a>
							</li>
							@endif
							
							@if(in_array("application_verifier_admin_dashboard",$permissions))
							<li class="active bold"><a class="{{ (Request::routeIs('application_verifier_admin_dashboard') ? 'active' : '') }}" href="{{route('application_verifier_admin_dashboard')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Ver. Admin Dash.</span></a>
							</li>
							@endif
		...
		@if(in_array("books_requrement",$permissions))
		<li class="active bold"><a class="{{ (Request::routeIs('booklisting') ? 'active' : '') || (Request::routeIs('bookadd') ? 'active' : '') || (Request::routeIs('bookedit') ? 'active' : '') }}" href="{{route('booklisting')}}"><i class="material-icons">contacts</i><span class="menu-title" data-i18n="Dashboard">Books Requirement</span></a>
		</li>
		@endif 
        ...
        @include('elements.dom.student_left_menue')
		@endif
		...
		<li class="{{  (Request::routeIs('supp_find_enrollment') ? 'active' : '') || (request()->routeIs(@$menus) ? 'active' : '')}}">
			
			<a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">chrome_reader_mode</i><span class="menu-title" data-i18n="Pages">Registrations</span></a>
		<div class="collapsible-body">
			<ul class="collapsible collapsible-sub" data-collapsible="accordion">
		...
		@if(in_array("sessional_find_enrollment",$permissions))
			<li class="bold"><a class="{{ (Request::routeIs('find_enrollment') ? 'active' : '')|| (Request::routeIs('marks_details') ? 'active' : '')|| (Request::routeIs('marks_preview_details') ? 'active' : '')}}" href="{{route('find_enrollment')}}"><i class="material-icons"> local_library</i><span class="menu-title" data-i18n="Mail">old Sessional Marks</span></a>
			</li>
		@endif
		
		
		@if(in_array("prepare_sessional_find_enrollment",$permissions))
			<li class="bold"><a class="{{ (Request::routeIs('prepare_find_enrollment') ? 'active' : '')|| (Request::routeIs('prepare_marks_details') ? 'active' : '')|| (Request::routeIs('prepare_marks_preview_details') ? 'active' : '')}}" href="{{route('prepare_find_enrollment')}}"><i class="material-icons"> local_library</i><span class="menu-title" data-i18n="Mail">Sessional Marks</span></a>
			</li>
		@endif
	...
	@if(in_array("reval_rte_copies",$permissions) || in_array("reval_marks_listing",$permissions) || in_array("reval_obtained_marks",$permissions))
		<li class="{{ (Request::routeIs('reval_student_applications') ? 'active' : '') || (Request::routeIs('reval_rte_copies') ? 'active' : '') || (Request::routeIs('reval_marks_listing') ? 'active' : '') || (Request::routeIs('reval_obtained_marks') ? 'active' : '') }}">
			<a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">accessibility_new</i><span class="menu-title" data-i18n="Mail">Revaluation</span></a>
			<div class="collapsible-body">
			<ul class="collapsible collapsible-sub" data-collapsible="accordion">
				@if(in_array("reval_marks_listing",$permissions)) 
					<li class="bold">
						<a class="{{ (Request::routeIs('reval_student_applications') ? 'active' : '')}}" href="{{ route('reval_student_applications',['exam_month' => @$reval_exam_month,'locksumbitted' => 1,'challan_tid2' => 1])}}" >						
					...
					<li class="bold">
						<a class="{{ (Request::routeIs('reval_marks_listing') ? 'active' : '')}}" href="{{route('reval_marks_listing')}}">
					<i class="material-icons">person_outline</i>
					<span class="menu-title" data-i18n="Dashboard">
						Reval Marks Listing
					</span>
				...
				@if(in_array("reval_obtained_marks",$permissions))
					<li class="bold">
						<a class="{{ (Request::routeIs('reval_obtained_marks') ? 'active' : '')}}" href="{{route('reval_obtained_marks')}}">
					<i class="material-icons">person_outline</i>
					<span class="menu-title" data-i18n="Dashboard">
						Reval Marks Obtained
					</span>
					</a>
					</li>
				@endif
				
				@if(in_array("reval_rte_copies",$permissions))
					<li class="bold">
						<a class="{{ (Request::routeIs('reval_rte_copies') ? 'active' : '')}}" href="{{route('reval_rte_copies')}}">
					<i class="material-icons">person_outline</i>
					<span class="menu-title" data-i18n="Dashboard">
						Reval RTI Copies
					</span>
	...
	@if(in_array("publish_publication_department_report",$permissions))
		<li class="bold"><a class="{{ (request()->routeIs('publish_publication_department_report') ? 'active' : '') }}" href="{{route('publish_publication_department_report')}}"><i class="material-icons">filter</i><span class="menu-title" data-i18n="Mail">Inventory Report</span></a>
		</li>
	@endif
	...
	(Request::routeIs('all_listing') ? 'active' : '') || (Request::routeIs('bank_masters.index') ? 'active' : '') || 
	...
	(Request::routeIs('aicenterusers.*') ? 'active' : '') || (Request::routeIs('students.*') ? 'active' : '') || (Request::routeIs('colleges.*') ? 'active' : '') || (Request::routeIs('roles.*') ? 'active' : '') || (Request::routeIs('permissions.*') ? 'active' : '') || (Request::routeIs('users.*') ? 'active' : '') ||(Request::routeIs('subjects.*') ? 'active' : '') ||(Request::routeIs('all_examcenterlisting') ? 'active' : '')
||(Request::routeIs('upload_doc') ? 'active' : '') ||(Request::routeIs('single_screen_dates') ? 'active' : ''||  (request()->routeIs('verfication_aicodes_details') ? 'active' : '') )
		...
		@endif
		<li class="bold"><a class="{{ (request()->routeIs('all_examcenterlisting') ? 'active' : '') }}" href="{{route('all_examcenterlisting')}}"><i class="material-icons">content_paste</i><span class="menu-title" data-i18n="Mail" title="Exam Center Allotment">Examcenter</span></a>
		</li>
		
		  @if(in_array("role_and_premission",$permissions))
		    <li class="{{ (Request::routeIs('users.*') ? 'active' : '') || (Request::routeIs('roles.*') ? 'active' : '') || (Request::routeIs('permissions.*') ? 'active' : '')  
		...
		@if(in_array("single-screen-dates",$permissions))
		<li class="bold"><a class="{{ (request()->routeIs('single_screen_dates') ? 'active' : '') }}" href="{{route('single_screen_dates')}}"><i class="material-icons">date_range</i><span class="menu-title" data-i18n="Mail">Single&nbsp;Screen&nbsp;Dates</span></a>
		</li>
		@endif	
		
		@if(in_array("verfication_aicodes_details",$permissions))
		<li class="bold"><a class="{{ (request()->routeIs('verfication_aicodes_details/ao') ? 'active' : '') }}" href="{{route('verfication_aicodes_details','ao')}}"><i class="material-icons">date_range</i><span class="menu-title" data-i18n="Mail">AO&nbsp;Aicodes</span></a>
		</li>
		
		<li class="bold"><a class="{{ (request()->routeIs('verfication_aicodes_details/verifier') ? 'active' : '') }}" href="{{route('verfication_aicodes_details','verifier')}}"><i class="material-icons">date_range</i><span class="menu-title" data-i18n="Mail">Verifier&nbsp;Aicodes</span></a>
		</li>
		...
		@endif 
         ...
         @if(in_array("bank_masters",$permissions))
		<li class="bold"><a class="{{ (request()->routeIs('bank_masters.index') ? 'active' : '') }}" href="{{route('bank_masters.index')}}"><i class="material-icons">location_city</i><span class="menu-title" data-i18n="Mail">Bank Masters</span></a>
		</li>
		@endif
	...
	@if(in_array("logdebug",$permissions))
		...
		@endif
			...
			@if(in_array("all_document_upload",$permissions))
			<li class="bold"><a class="{{ (request()->routeIs('upload_doc') ? 'active' : '') }}" href="{{route('upload_doc')}}"><i class="material-icons">control_point_duplicate</i><span class="menu-title" data-i18n="Mail">Upload Any file</span></a>
			</li>
			@endif
			</ul>
		</div>
		...
		<li class="{{ (Request::routeIs('searchstudentdetail') ? 'active' : '') || (Request::routeIs('Serach_Enrollment') ? 'active' : '') || (Request::routeIs('updateindex') ? 'active' : '')}}"><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">content_paste</i><span class="menu-title" data-i18n="Pages">Updations </span></a>
		<div class="collapsible-body">
			<ul class="collapsible collapsible-sub" data-collapsible="accordion">
			@if(in_array("result_update",$permissions))
		<li class="bold"><a class="{{ (request()->routeIs('updateindex') ? 'active' : '')  || (Request::routeIs('editresult') ? 'active' : '')  }}" href="{{route('updateindex')}}"><i class="material-icons">assignment return</i><span class="menu-title" data-i18n="Mail">Result Update</span></a>
		</li>
		@endif
		...
		)}}"><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">add_to_queue</i><span class="menu-title" data-i18n="Mail">Materials</span></a>
		<div class="collapsible-body">
			<ul class="collapsible collapsible-sub" data-collapsible="accordion">
	...
	@if(in_array("examcentermateriel",$permissions))
		...
		<div class="collapsible-body">
			...
			@endif
			@if(in_array("aicodenominalnattendance",$permissions))
		...
		@endif
		 @if(in_array("stickers",$permissions))
		<li class=""><a href="{{route('enrollment_fixcode_views')}}" class="{{ (request()->routeIs('enrollment_fixcode_views') ? 'active' : '') }}"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Contact">Stickers </span></a>
		</li>
		@endif
	...
	@if(in_array("theory_examiner_map_listing",$permissions))
		...
		@if(in_array("verifier_dashboard",$permissions)) 
			<li class="active bold"><a class="{{ (Request::routeIs('applicationverifyerdashboard') ? 'active' : '') }}" href="{{route('applicationverifyerdashboard')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard"> Verifier Dashboard</span></a>
			</li>
		@endif  

		@if(in_array("ao_dashboard",$permissions)) 
			<li class="active bold"><a class="{{ (Request::routeIs('applicationacademicofficer_dashboard') ? 'active' : '') }}" href="{{route('applicationacademicofficer_dashboard')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard"> AO Dashboard</span></a>
			</li>
		@endif  
 ...
 @if(in_array("last_student_details",$permissions))
		<li class="bold">
			<a class="{{ (Request::routeIs('generate_last_years_student_subject_data_setting') ? 'active' : '')}}" href="{{route('generate_last_years_student_subject_data_setting')}}"><i class="material-icons"> dvr</i><span class="menu-title" data-i18n="Mail">Last Year Student Details</span></a>
		</li>
	  @endif
	  
	@if(in_array("complete_full_year_student_applications",$permissions))
		<li class="bold">
			<a class="{{ (Request::routeIs('student_applications') ? 'active' : '')}}" href="{{ route('student_applications',['is_full'=> 1]) }}"><i class="material-icons"> assignment_ind</i><span class="menu-title" data-i18n="Mail">All Years Student Report</span></a>
		</li>
	  @endif
...
<script>
	$('.1').addClass('active').removeClass('1');
</script>