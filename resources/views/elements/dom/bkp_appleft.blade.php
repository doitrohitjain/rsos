...
@endphp
    ...
    @if(in_array("all_dashboard",$permissions))
	  ...
	  Request::routeIs('evaluationdashboard') ? 'active' : '' || Request::routeIs('publication_dept') ? 'active' : '' || 
	  Request::routeIs('users.*') ? 'active' : '' || Request::routeIs('theroyexaminerdashboard') ? 'active' : '' || Request::routeIs('colleges.*') ? 'active' : '' || Request::routeIs('deodashboard') ? 'active' : '' || Request::routeIs('permissions.*') ? 'active' : ''
	   ...
	   @endif
		...
		@if(in_array("publication_dept_dashboard",$permissions))
		 <li class="active bold"><a class="{{ Request::routeIs('publication_dept') ? 'active' : '' }}" href="{{route('publication_dept')}}"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="Dashboard">Publication Depatment Dashboard</span></a>
         </li>
		@endif
		...
		<li class="bold">
			<a class="{{ Request::routeIs('booklisting') ? 'active' : '' ? 'active' : '' || Request::routeIs('bookadd') ? 'active' : '' ? 'active' : ''}}" href="{{route('booklisting')}}"><i class="material-icons"> local_library</i><span class="menu-title" data-i18n="Mail">Books Requirement</span></a>
		</li>
	  @endif
    ...
    @if(in_array("all_master",$permissions))
	  ...
	  Request::routeIs('users.*') ? 'active' : ''||Request::routeIs('subjects.*') ? 'active' : ''
	   ...
	   @if(in_array("logdebug",$permissions))
		...
		<li class="{{ Request::routeIs('searchstudentdetail') ? 'active' : '' || Request::routeIs('Serach_Enrollment') ? 'active' : '' || Request::routeIs('updateindex') ? 'active' : ''}}"><a class="collapsible-header waves-effect waves-cyan" href="JavaScript:void(0)"><i class="material-icons">account_box</i><span class="menu-title" data-i18n="Pages">Updations </span></a>
          <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
