                                ...
                                @php
                                    if(@$value->deleted_at){
                                        ...
                                        <div class="invoice-action"> 
                                            <a href="{{ route('editexamcenter',Crypt::encrypt($value->id)) }}" class="invoice-action-edit">
											...
											<a href="{{ route('examcenters_aicenter_unmaapeduserid',Crypt::encrypt($value->id)) }}" class="invoice-action-view delete-confirm">
