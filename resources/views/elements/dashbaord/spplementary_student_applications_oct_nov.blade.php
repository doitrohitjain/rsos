			...
			<div class="seaction">
				<div class="card">
					<div class="card-content">
						<h5>Supplementary October November</h5>
						<div class="row">
							<div id="card-stats" class="pt-0">
											...
											<div class="padding-4">
												<div class="row">
													...
													<div class="col s5 m5 right-align">
														...
														<p class="no-margin"><a href="{{ route('supplementary_student_applications',[2]) }}" class="white-text" >Click Here</a></p>
													</div>
												</div>
										</div>
										</div>
										...
										<div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft dashboard-link-box">
											<div class="padding-4">
												<div class="row">
													...
													<p class="no-margin"><a href="{{ route('supplementary_student_locksumbited_applications',[2])}}" class="white-text" >Click Here</a></p>
								...
								<div class="col s12 m6 l5 xl4">
										<div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft dashboard-link-box">
											<a href="{{ route('allsupplementary_student_not_pay_payment_details',[2]) }}" >						
												<div class="padding-4">
												<div class="row">
													<div class="col s7 m7">
														<i class="material-icons background-round mt-5 mb-5">attach_money</i>
									...
									<div class="col s12 m6 l5 xl4">
										<div class="card gradient-45deg-purple-deep-purple  gradient-shadow min-height-100 white-text animate fadeRight dashboard-link-box">
											<a href="{{ route('allsupplementary_student_payment_details',[2]) }}" >
												<div class="padding-4">
												<div class="row">
													<div class="col s7 m7">
														<i class="material-icons background-round mt-5 mb-5">attach_money</i>
												...
												<div class="row">
													...
													<div class="col s5 m5 right-align">
														<h5 class="mb-0 white-text">
															{{@$supplementary_get_Eligiable_Students}}
														</h5>
														<p class="no-margin"></p>
													</div>
												</div>
