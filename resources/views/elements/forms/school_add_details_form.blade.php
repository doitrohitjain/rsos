        ...
        <div class="col s12">
                ...
                <div class="row">
                    ...
                    @foreach(@$formFields as $k => $v)
                        ...
                        @if(@$v['fld'] == "BoardAffiliationCode")
                            <div class="input-field col m6 s12">
                        @elseif (@$v['fld'] == "PrincipalOrHeadmasterEmail" || @$v['fld'] == "SchoolEmailID"
                        || @$v['fld'] == "Is_ElectricityConnection" || @$v['fld'] == "Is_InternetConnection"
                        || @$v['fld'] == "AssembalyName"|| @$v['fld'] == "MobileNo" ||@$v['fld'] == "IFMS_ID"
                        )
                            <div class="input-field col m6 s12">
                        @elseif (@$v['fld'] == "School_Type" || @$v['fld'] == "School_Type")
                        <div class="input-field col m6 s12">
                        @else
