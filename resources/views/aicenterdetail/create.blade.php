				...
				<div class="row">
					<div class="col s12">
						<div id="html-validations" class="card card-tabs">
							<div class="card-content">
								<h6>AI Center From </h6></br>
								<div id="html-view-validations">
									{!! Form::open(array('route' => 'aicenterusers.store','method'=>'POST','id' => $model)) !!}
										...
										<div class="row">
											...
											<div class="col m4 s12">
												...
												<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
												<div class="input-field">
												{!! Form::select($fld,$allssoid,null,['class' => 'select2 browser-default form-control','placeholder' => $placeholder,]) !!}
												@include('elements.field_error')
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col m4 s12">
												...
												<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
												<div class="input-field">
												{!! Form::select($fld,@$banks,null,['class' => 'select2 browser-default form-control banks','placeholder' => $placeholder,]) !!}
												@include('elements.field_error')
												</div>
											</div>
											<div class="col m4 s12">
												...
												<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
												<div class="input-field">
												{!!Form::text($fld,null,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>25,'minLength'=>12]); !!}
													@include('elements.field_error')	
												</div>
											</div>
											<div class="col m4 s12">
										...
										<div class="row">
											...
											<div class="col m4 s12">
												...
												<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
												<div class="input-field">
												{!!Form::text($fld,null,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>10,'minLength'=>10]); !!}
													@include('elements.field_error')	
												</div>
											</div>
											<div class="col m4 s12">
											...
											<div class="col m4 s12">
												...
												<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
												<div class="input-field">
												{!!Form::text($fld,null,['type'=>'text','class'=>'form-control num','autocomplete'=>'off','placeholder' => $lbl,'maxlength'=>6,'minLength'=>6]); !!}
													@include('elements.field_error')	
												</div>
											</div>
											<div class="col m4 s12">
