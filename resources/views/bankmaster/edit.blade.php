          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Bank</span></h5>
              </div>
    ...
    <div class="col s12 m12 l12">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
		  ...
		  {!! Form::model($bankdata, ['method' => 'PATCH','route' => ['bank_masters.update',$bankdata->id],'id' => $model]) !!}
            ...
            <div class="row">
                <div class="col m4 s12">
					...
					<div class="input-field">{!!Form::text($fld,$bankdata->$fld,['type'=>'text','class'=>'form-control','autocomplete'=>'off','required' => 'required','placeholder' => $lbl]); !!}
				...
				<div class="col m4 s12">
					...
					<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
					<div class="input-field">{!!Form::text($fld,$bankdata->$fld,['type'=>'text','required' => 'required','class'=>'form-control','autocomplete'=>'off','placeholder' => $lbl]); !!}
					@include('elements.field_error')	
					</div>
				</div>
				...
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
					<div class="input-field">{!!Form::text($fld,$bankdata->$fld,['type'=>'text','class'=>'form-control ','required' => 'required','autocomplete'=>'off','placeholder' => $lbl]); !!}
					 @include('elements.field_error')	
					</div>
				</div>
            </div>
            <div class="row">
				...
				<span class="small_lable">@php echo $lbl .Config::get('global.starMark'); @endphp </span>
					<div class="input-field">{!!Form::textarea($fld,$bankdata->$fld,['type'=>'text','class'=>'form-control ','autocomplete'=>'off','required' => 'required','placeholder' => $lbl]); !!}
					 @include('elements.field_error')	
					</div>
				</div>
		    </div>
