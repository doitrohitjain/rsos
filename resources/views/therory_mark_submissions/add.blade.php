												...
												<div class="row">
													...
													<div class="col m9 s12 mb-3" style="margin-top:1%">
														@php
															...
															if(Route::current()->action['as'] == "theory_add_marks"){
																$paramName1 = Route::current()->parameters()['id'];
																@endphp 
																<a href="{{ action($route, $paramName1) }}" class="btn cyan waves-effect waves-light left"><i class="material-icons left">send</i>Go To First Page</a>
																@php 
															}else{
																@endphp
																	<a href="{{ action($route) }}" class="btn cyan waves-effect waves-light left"><i class="material-icons left">send</i>Go To First Page</a> 
																@php 
															}
														@endphp 
													</div>
													<?php if($result->lastPage()==$result->currentPage()){ ?>
														<div class="col m3 s12 mb-3" style="margin-top:1%">
															<button class="btn cyan waves-effect waves-light gradient-45deg-deep-orange-orange right" type="submit" name="action">Save & Preview
