															...
															<tr>
																...
																<td>
																	...
																	@elseif(@$data->theory_absent=='2')
																		...
																		<input type='hidden' name='data[{{ $k }}][student_allotment_marks_id]' class='student_allotment_marks_id' value='{{Crypt::encrypt($data->id)}}' disabled>
																	@else
																	<input type='text' id="theorymarks<?php echo $i; ?>" name='data[{{ $k }}][final_theory_marks]' class="final_practical_marks final_practical_marks_<?php echo $i; ?>  check_absent_marks" value="{{ $data->final_theory_marks}}">
