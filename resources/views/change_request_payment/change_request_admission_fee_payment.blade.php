								...
								<div class="card-content">
									...
									<div class="row">
										<!-- <div class="input-field col s6">
											...
											{!!Form::text($fld,@$master->$fld,['type'=>'text','class'=>'requried form-control','maxlength'=>70,'minLength'=>2,'autocomplete'=>'off']); !!}
										...
										<div class="input-field col s6">
											...
											<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
											{!!Form::text($fld,@$master->$fld,['type'=>'text','class'=>'num requried form-control','maxlength'=>10,'minLength'=>10,'autocomplete'=>'off']); !!}
											@include('elements.field_error')
										</div>
										<div class="input-field col s6">
									...
									<div class="row">
										<div class="input-field col s5">
											...
											<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
											{!!Form::text($fld,@$master->$fld,['type'=>'text','class'=>'requried2 form-control','maxlength'=>70,'minLength'=>2,'autocomplete'=>'off']); !!}
											@include('elements.field_error')
										</div>
										...
										<div class="input-field col s5">
											@php $lbl='Jan Aadhar Number'; $fld='jan_aadhar_number'; @endphp
											<h8>{!!Form::label($fld, $lbl) !!}@php echo Config::get('global.starMark'); @endphp</h8>
											{!!Form::text($fld,@$master->$fld,['type'=>'text','class'=>'requried2 form-control','maxlength'=>70,'minLength'=>2,'autocomplete'=>'off']); !!}
											@include('elements.field_error')
										</div>
									...
									<div class="row">
										<div class="col m10 s12 mb-3">
											<button class="btn cyan waves-effect waves-light right show_confirm" type="submit" name="action"> 
												Search & Continue
											</button>
										</div>
...
@endsection 
@section('customjs')
	<script src="{!! asset('public/app-assets/js/bladejs/payment/admission_fee_payment.js') !!}"></script> 
@endsection