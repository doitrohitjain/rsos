					...
					<div class="seaction">
						...
						<div class="col s12 m12 l12">
							<div class="card-content">
								<?php  
									if($isAlreadyRaisedRequest > 0 && $student->update_change_requests_challan_tid == "" ){ ?>
								<br/>
								<hr/>
								...
								style="" href="{{ route('change_request_verify_request',Crypt::encrypt(@$student->id)) }}">
									Verify Your Payment
								</a> 
								...
								<?php if( $issueCount <= 0){ ?>
									...
									In case you want to raise a request to admin for your transaction got failed, please click on the raise a request button.
										...
										<a class="btn cyan waves-effect waves-light border-round gradient-45deg-purple-deep-orange"  href="{{ route('change_request_raise_request',Crypt::encrypt(@$student->id)) }}">
							...
							<div id="Form-advance" class="card card card-default scrollspy">
								...
								<div class="card-content">
									...
									<div class="card-content">
										...
										if(@$student->update_change_requests_challan_tid && $student->update_change_requests_challan_tid != ""){ ?>
											<?php 
								...
								<!-- Fee payment button start -->
									<div class="card-content">
										...
										if($student->update_change_requests_challan_tid == "" && $checkchangerequestsAllowOrNotAllow == true){
